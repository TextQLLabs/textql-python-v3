...
class Observability(BaseSDK):
    ...
    def get_member_signal_trend(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ObservabilityServiceGetMemberSignalTrendResponse:
        r"""GetMemberSignalTrend
        ...
        request = models.ObservabilityServiceGetMemberSignalTrendRequest(
            connect_timeout_ms=connect_timeout_ms,
        ...
        req = self._build_request(
            method="POST",
            path="/textql.rpc.public.observe.ObservabilityService/GetMemberSignalTrend",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.TextqlRPCPublicObserveGetMemberSignalTrendRequest,
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="ObservabilityService_GetMemberSignalTrend",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.TextqlRPCPublicObserveGetMemberSignalTrendResponse, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.TextqlDefaultError(
    ...
    async def get_member_signal_trend_async(
        self,
        *,
        connect_timeout_ms: Optional[float] = None,
        days: Optional[int] = None,
