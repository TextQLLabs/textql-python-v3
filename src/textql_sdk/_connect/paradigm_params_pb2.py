...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PARADIGMPARAMS'].fields_by_name['ontology_editing_enabled']._loaded_options = None
    _globals['_PARADIGMPARAMS'].fields_by_name['ontology_editing_enabled']._serialized_options = b'\xfa\xd2\xe4\x93\x02\n\x12\x08INTERNAL'
    _globals['_PARADIGMPARAMS'].fields_by_name['auto_approve_enabled']._loaded_options = None
    _globals['_PARADIGMPARAMS'].fields_by_name['auto_approve_enabled']._serialized_options = b'\xfa\xd2\xe4\x93\x02\n\x12\x08INTERNAL'
    _globals['_PARADIGMPARAMS'].fields_by_name['context_editing_enabled']._loaded_options = None
    _globals['_PARADIGMPARAMS'].fields_by_name['context_editing_enabled']._serialized_options = b'\xfa\xd2\xe4\x93\x02\n\x12\x08INTERNAL'
    _globals['_PARADIGMPARAMS'].fields_by_name['multiple_connector_mode']._loaded_options = None
    _globals['_PARADIGMPARAMS'].fields_by_name['multiple_connector_mode']._serialized_options = b'\x18\x01'
    _globals['_PARADIGMTYPE']._serialized_start = 1747
    _globals['_PARADIGMTYPE']._serialized_end = 2245
    _globals['_PARADIGMPARAMS']._serialized_start = 108
    _globals['_PARADIGMPARAMS']._serialized_end = 1744