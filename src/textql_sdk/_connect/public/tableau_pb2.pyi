...
class TableauWorkbook(_message.Message):
    ...
    def __init__(self, id: _Optional[str]=..., name: _Optional[str]=..., project_name: _Optional[str]=..., project_id: _Optional[str]=..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class TableauView(_message.Message):
    ...
    def __init__(self, id: _Optional[str]=..., name: _Optional[str]=..., content_url: _Optional[str]=..., workbook_id: _Optional[str]=..., workbook_name: _Optional[str]=..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., embed_url: _Optional[str]=...) -> None:
        ...
...
class TableauDatasource(_message.Message):
    ...
    def __init__(self, id: _Optional[str]=..., name: _Optional[str]=..., type: _Optional[str]=..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., is_published: bool=..., project_id: _Optional[str]=..., project_name: _Optional[str]=...) -> None:
        ...
...
class TableauStarredItem(_message.Message):
    ...
    def __init__(self, connector_id: _Optional[int]=..., item_type: _Optional[_Union[TableauItemType, str]]=..., item_id: _Optional[str]=..., item_name: _Optional[str]=..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class GenerateEmbedTokenRequest(_message.Message):
    __slots__ = ('connector_id', 'view_id')
    CONNECTOR_ID_FIELD_NUMBER: _ClassVar[int]
    VIEW_ID_FIELD_NUMBER: _ClassVar[int]
    connector_id: int
    view_id: str

    def __init__(self, connector_id: _Optional[int]=..., view_id: _Optional[str]=...) -> None:
        ...

class GenerateEmbedTokenResponse(_message.Message):
    __slots__ = ('token', 'embed_url')
    TOKEN_FIELD_NUMBER: _ClassVar[int]
    EMBED_URL_FIELD_NUMBER: _ClassVar[int]
    token: str
    embed_url: str

    def __init__(self, token: _Optional[str]=..., embed_url: _Optional[str]=...) -> None:
        ...

class GetConnectedAppStatusRequest(_message.Message):
    __slots__ = ('connector_id',)
    CONNECTOR_ID_FIELD_NUMBER: _ClassVar[int]
    connector_id: int
...
class GetConnectedAppStatusResponse(_message.Message):
    __slots__ = ('configured', 'app_name', 'client_id_suffix', 'secret_id_suffix')
    CONFIGURED_FIELD_NUMBER: _ClassVar[int]
    APP_NAME_FIELD_NUMBER: _ClassVar[int]
    CLIENT_ID_SUFFIX_FIELD_NUMBER: _ClassVar[int]
    SECRET_ID_SUFFIX_FIELD_NUMBER: _ClassVar[int]
    configured: bool
    app_name: str
    client_id_suffix: str
    secret_id_suffix: str

    def __init__(self, configured: bool=..., app_name: _Optional[str]=..., client_id_suffix: _Optional[str]=..., secret_id_suffix: _Optional[str]=...) -> None:
        ...

class ResetConnectedAppRequest(_message.Message):
    __slots__ = ('connector_id',)
    CONNECTOR_ID_FIELD_NUMBER: _ClassVar[int]
    connector_id: int
...
class ResetConnectedAppResponse(_message.Message):
    __slots__ = ('success',)
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    success: bool
...
class RefreshTableauCollectionRequest(_message.Message):
    __slots__ = ('dataset_id',)
    DATASET_ID_FIELD_NUMBER: _ClassVar[int]
    dataset_id: str
...
class RefreshTableauCollectionResponse(_message.Message):
    __slots__ = ('views_count', 'datasources_count')
    VIEWS_COUNT_FIELD_NUMBER: _ClassVar[int]
    DATASOURCES_COUNT_FIELD_NUMBER: _ClassVar[int]
    views_count: int
    datasources_count: int

    def __init__(self, views_count: _Optional[int]=..., datasources_count: _Optional[int]=...) -> None:
        ...