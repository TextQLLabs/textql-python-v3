...
class ListPowerBIWorkspacesResponse(_message.Message):
    ...
    def __init__(self, workspaces: _Optional[_Iterable[_Union[PowerBIWorkspace, _Mapping]]]=..., error: _Optional[str]=...) -> None:
        ...
...
class ListPowerBIDatasetsResponse(_message.Message):
    ...
    def __init__(self, datasets: _Optional[_Iterable[_Union[PowerBIDataset, _Mapping]]]=..., error: _Optional[str]=...) -> None:
        ...
...
class PowerBIReport(_message.Message):
    ...
    def __init__(self, id: _Optional[str]=..., name: _Optional[str]=..., web_url: _Optional[str]=..., embed_url: _Optional[str]=..., dataset_id: _Optional[str]=..., created_by: _Optional[str]=..., created_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class ListPowerBIReportsResponse(_message.Message):
    __slots__ = ('reports', 'error')
    REPORTS_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    reports: _containers.RepeatedCompositeFieldContainer[PowerBIReport]
    error: str

    def __init__(self, reports: _Optional[_Iterable[_Union[PowerBIReport, _Mapping]]]=..., error: _Optional[str]=...) -> None:
        ...
...
class ExportPowerBIReportImageResponse(_message.Message):
    __slots__ = ('image_data', 'image_url', 'error')
    ...
    def __init__(self, image_data: _Optional[bytes]=..., image_url: _Optional[str]=..., error: _Optional[str]=...) -> None:
        ...
...
class GeneratePowerBIEmbedTokenResponse(_message.Message):
    ...
    def __init__(self, token: _Optional[str]=..., token_id: _Optional[str]=..., expiration: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class SyncedPowerBIReport(_message.Message):
    ...
    def __init__(self, report: _Optional[_Union[PowerBIReport, _Mapping]]=..., workspace_id: _Optional[str]=..., workspace_name: _Optional[str]=..., synced_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class SyncedPowerBIDataset(_message.Message):
    ...
    def __init__(self, dataset: _Optional[_Union[PowerBIDataset, _Mapping]]=..., workspace_id: _Optional[str]=..., workspace_name: _Optional[str]=..., synced_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
