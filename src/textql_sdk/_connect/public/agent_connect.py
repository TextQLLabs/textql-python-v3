...
class AgentService(Protocol):
    ...
    async def get_agent_d_b_schema(self, request: public_dot_agent__pb2.GetAgentDBSchemaRequest, ctx: RequestContext) -> public_dot_agent__pb2.GetAgentDBSchemaResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')

    async def get_agent_d_b_table_preview(self, request: public_dot_agent__pb2.GetAgentDBTablePreviewRequest, ctx: RequestContext) -> public_dot_agent__pb2.GetAgentDBTablePreviewResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class AgentServiceClient(ConnectClient):
    ...
    async def get_agent_d_b_schema(self, request: public_dot_agent__pb2.GetAgentDBSchemaRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None, use_get: bool=False) -> public_dot_agent__pb2.GetAgentDBSchemaResponse:
        return await self.execute_unary(request=request, method=MethodInfo(name='GetAgentDBSchema', service_name='textql.rpc.public.agent.AgentService', input=public_dot_agent__pb2.GetAgentDBSchemaRequest, output=public_dot_agent__pb2.GetAgentDBSchemaResponse, idempotency_level=IdempotencyLevel.NO_SIDE_EFFECTS), headers=headers, timeout_ms=timeout_ms, use_get=use_get)

    async def get_agent_d_b_table_preview(self, request: public_dot_agent__pb2.GetAgentDBTablePreviewRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None, use_get: bool=False) -> public_dot_agent__pb2.GetAgentDBTablePreviewResponse:
        return await self.execute_unary(request=request, method=MethodInfo(name='GetAgentDBTablePreview', service_name='textql.rpc.public.agent.AgentService', input=public_dot_agent__pb2.GetAgentDBTablePreviewRequest, output=public_dot_agent__pb2.GetAgentDBTablePreviewResponse, idempotency_level=IdempotencyLevel.NO_SIDE_EFFECTS), headers=headers, timeout_ms=timeout_ms, use_get=use_get)
...
class AgentServiceSync(Protocol):
    ...
    def get_agent_d_b_schema(self, request: public_dot_agent__pb2.GetAgentDBSchemaRequest, ctx: RequestContext) -> public_dot_agent__pb2.GetAgentDBSchemaResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')

    def get_agent_d_b_table_preview(self, request: public_dot_agent__pb2.GetAgentDBTablePreviewRequest, ctx: RequestContext) -> public_dot_agent__pb2.GetAgentDBTablePreviewResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class AgentServiceClientSync(ConnectClientSync):
    ...
    def get_agent_d_b_schema(self, request: public_dot_agent__pb2.GetAgentDBSchemaRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None, use_get: bool=False) -> public_dot_agent__pb2.GetAgentDBSchemaResponse:
        return self.execute_unary(request=request, method=MethodInfo(name='GetAgentDBSchema', service_name='textql.rpc.public.agent.AgentService', input=public_dot_agent__pb2.GetAgentDBSchemaRequest, output=public_dot_agent__pb2.GetAgentDBSchemaResponse, idempotency_level=IdempotencyLevel.NO_SIDE_EFFECTS), headers=headers, timeout_ms=timeout_ms, use_get=use_get)

    def get_agent_d_b_table_preview(self, request: public_dot_agent__pb2.GetAgentDBTablePreviewRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None, use_get: bool=False) -> public_dot_agent__pb2.GetAgentDBTablePreviewResponse:
        return self.execute_unary(request=request, method=MethodInfo(name='GetAgentDBTablePreview', service_name='textql.rpc.public.agent.AgentService', input=public_dot_agent__pb2.GetAgentDBTablePreviewRequest, output=public_dot_agent__pb2.GetAgentDBTablePreviewResponse, idempotency_level=IdempotencyLevel.NO_SIDE_EFFECTS), headers=headers, timeout_ms=timeout_ms, use_get=use_get)