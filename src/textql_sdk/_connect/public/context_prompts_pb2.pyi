...
class ContextPrompt(_message.Message):
    __slots__ = ('id', 'name', 'prompt', 'is_org', 'active', 'assigned_roles', 'assigned_datasets', 'assigned_connectors', 'created_at', 'updated_at', 'auto_attach', 'can_write', 'is_public')
...
class CreateContextPromptRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str]=..., prompt: _Optional[str]=..., is_org: bool=..., initial_role_ids: _Optional[_Iterable[str]]=..., initial_datasets: _Optional[_Iterable[str]]=..., initial_connectors: _Optional[_Iterable[int]]=..., auto_attach: bool=...) -> None:
        ...
...
class UpdateContextPromptRequest(_message.Message):
    __slots__ = ('id', 'name', 'prompt', 'is_org', 'auto_attach')
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    PROMPT_FIELD_NUMBER: _ClassVar[int]
    IS_ORG_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[str]=..., name: _Optional[str]=..., prompt: _Optional[str]=..., is_org: bool=..., auto_attach: bool=...) -> None:
        ...
