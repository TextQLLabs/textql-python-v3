...
class ObservabilityService(Protocol):
    ...
    async def get_playbook_billing_stats(self, request: public_dot_observe__pb2.GetPlaybookBillingStatsRequest, ctx: RequestContext) -> public_dot_observe__pb2.GetPlaybookBillingStatsResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class ObservabilityServiceClient(ConnectClient):
    ...
    async def get_playbook_billing_stats(self, request: public_dot_observe__pb2.GetPlaybookBillingStatsRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None, use_get: bool=False) -> public_dot_observe__pb2.GetPlaybookBillingStatsResponse:
...
class ObservabilityServiceSync(Protocol):
    ...
    def get_playbook_billing_stats(self, request: public_dot_observe__pb2.GetPlaybookBillingStatsRequest, ctx: RequestContext) -> public_dot_observe__pb2.GetPlaybookBillingStatsResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class ObservabilityServiceClientSync(ConnectClientSync):
    ...
    def get_playbook_billing_stats(self, request: public_dot_observe__pb2.GetPlaybookBillingStatsRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None, use_get: bool=False) -> public_dot_observe__pb2.GetPlaybookBillingStatsResponse:
