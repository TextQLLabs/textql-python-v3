...
class DatasetFolder(_message.Message):
    ...
    def __init__(self, path: _Optional[str]=..., owner: _Optional[_Union[_identity_pb2.MemberPreview, _Mapping]]=..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class PowerBIData(_message.Message):
    __slots__ = ('connector_id', 'report_ids', 'dataset_ids', 'report_names', 'dataset_names', 'workspace_id', 'workspace_name')
    CONNECTOR_ID_FIELD_NUMBER: _ClassVar[int]
    REPORT_IDS_FIELD_NUMBER: _ClassVar[int]
    DATASET_IDS_FIELD_NUMBER: _ClassVar[int]
    REPORT_NAMES_FIELD_NUMBER: _ClassVar[int]
    ...
    report_names: _containers.RepeatedScalarFieldContainer[str]
    dataset_names: _containers.RepeatedScalarFieldContainer[str]
    workspace_id: str
    workspace_name: str

    def __init__(self, connector_id: _Optional[int]=..., report_ids: _Optional[_Iterable[str]]=..., dataset_ids: _Optional[_Iterable[str]]=..., report_names: _Optional[_Iterable[str]]=..., dataset_names: _Optional[_Iterable[str]]=..., workspace_id: _Optional[str]=..., workspace_name: _Optional[str]=...) -> None:
        ...
