...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SANDBOXSUMMARY']._serialized_start = 126
    _globals['_SANDBOXSUMMARY']._serialized_end = 392
    _globals['_LISTSANDBOXESREQUEST']._serialized_start = 394
    _globals['_LISTSANDBOXESREQUEST']._serialized_end = 486
    _globals['_LISTSANDBOXESRESPONSE']._serialized_start = 489
    _globals['_LISTSANDBOXESRESPONSE']._serialized_end = 624
    _globals['_STOPSANDBOXREQUEST']._serialized_start = 626
    _globals['_STOPSANDBOXREQUEST']._serialized_end = 677
    _globals['_STOPSANDBOXRESPONSE']._serialized_start = 679
    _globals['_STOPSANDBOXRESPONSE']._serialized_end = 726
    _globals['_RESTARTSANDBOXREQUEST']._serialized_start = 728
    _globals['_RESTARTSANDBOXREQUEST']._serialized_end = 782
    _globals['_RESTARTSANDBOXRESPONSE']._serialized_start = 784
    _globals['_RESTARTSANDBOXRESPONSE']._serialized_end = 898
    _globals['_GETSANDBOXREQUEST']._serialized_start = 900
    _globals['_GETSANDBOXREQUEST']._serialized_end = 950
    _globals['_GETSANDBOXRESPONSE']._serialized_start = 953
    _globals['_GETSANDBOXRESPONSE']._serialized_end = 1216
    _globals['_SANDBOXDATAFRAME']._serialized_start = 1219
    _globals['_SANDBOXDATAFRAME']._serialized_end = 1357
    _globals['_SANDBOXEXECUTION']._serialized_start = 1360
    _globals['_SANDBOXEXECUTION']._serialized_end = 1613
    _globals['_LISTSANDBOXEXECUTIONSREQUEST']._serialized_start = 1615
    _globals['_LISTSANDBOXEXECUTIONSREQUEST']._serialized_end = 1722
    _globals['_LISTSANDBOXEXECUTIONSRESPONSE']._serialized_start = 1725
    _globals['_LISTSANDBOXEXECUTIONSRESPONSE']._serialized_end = 1872
    _globals['_SANDBOXFILEENTRY']._serialized_start = 1875
    _globals['_SANDBOXFILEENTRY']._serialized_end = 2048
    _globals['_LISTSANDBOXFILESREQUEST']._serialized_start = 2050
    _globals['_LISTSANDBOXFILESREQUEST']._serialized_end = 2126
    _globals['_LISTSANDBOXFILESRESPONSE']._serialized_start = 2129
    _globals['_LISTSANDBOXFILESRESPONSE']._serialized_end = 2262
    _globals['_READSANDBOXFILEREQUEST']._serialized_start = 2264
    _globals['_READSANDBOXFILEREQUEST']._serialized_end = 2339
    _globals['_SANDBOXEGRESSCALL']._serialized_start = 2342
    _globals['_SANDBOXEGRESSCALL']._serialized_end = 2719
    _globals['_LISTSANDBOXEGRESSREQUEST']._serialized_start = 2721
    _globals['_LISTSANDBOXEGRESSREQUEST']._serialized_end = 2800
    _globals['_LISTSANDBOXEGRESSRESPONSE']._serialized_start = 2802
    _globals['_LISTSANDBOXEGRESSRESPONSE']._serialized_end = 2903
    _globals['_SANDBOXSPENDINTERVAL']._serialized_start = 2906
    _globals['_SANDBOXSPENDINTERVAL']._serialized_end = 3137
    _globals['_LISTSANDBOXSPENDREQUEST']._serialized_start = 3139
    _globals['_LISTSANDBOXSPENDREQUEST']._serialized_end = 3195
    _globals['_LISTSANDBOXSPENDRESPONSE']._serialized_start = 3198
    _globals['_LISTSANDBOXSPENDRESPONSE']._serialized_end = 3426
    _globals['_SANDBOXRESOURCESAMPLE']._serialized_start = 3429
    _globals['_SANDBOXRESOURCESAMPLE']._serialized_end = 3795
    _globals['_LISTSANDBOXRESOURCESREQUEST']._serialized_start = 3798
    _globals['_LISTSANDBOXRESOURCESREQUEST']._serialized_end = 3982
    _globals['_LISTSANDBOXRESOURCESRESPONSE']._serialized_start = 3985
    _globals['_LISTSANDBOXRESOURCESRESPONSE']._serialized_end = 4115
    _globals['_STOREDSANDBOXRESOURCESAMPLE']._serialized_start = 4118
    _globals['_STOREDSANDBOXRESOURCESAMPLE']._serialized_end = 4356
    _globals['_READSANDBOXFILERESPONSE']._serialized_start = 4359
    _globals['_READSANDBOXFILERESPONSE']._serialized_end = 4618
    _globals['_SANDBOXADMINSERVICE']._serialized_start = 4621
    _globals['_SANDBOXADMINSERVICE']._serialized_end = 6055