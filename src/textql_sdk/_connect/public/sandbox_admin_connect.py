...
class SandboxAdminService(Protocol):
    ...
    async def get_sandbox_lease_settings(self, request: public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsRequest, ctx: RequestContext) -> public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')

    async def set_sandbox_lease_settings(self, request: public_dot_sandbox__admin__pb2.SetSandboxLeaseSettingsRequest, ctx: RequestContext) -> public_dot_sandbox__admin__pb2.SetSandboxLeaseSettingsResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class SandboxAdminServiceClient(ConnectClient):
    ...
    async def get_sandbox_lease_settings(self, request: public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None, use_get: bool=False) -> public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsResponse:
        return await self.execute_unary(request=request, method=MethodInfo(name='GetSandboxLeaseSettings', service_name='textql.rpc.public.sandbox_admin.SandboxAdminService', input=public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsRequest, output=public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsResponse, idempotency_level=IdempotencyLevel.NO_SIDE_EFFECTS), headers=headers, timeout_ms=timeout_ms, use_get=use_get)

    async def set_sandbox_lease_settings(self, request: public_dot_sandbox__admin__pb2.SetSandboxLeaseSettingsRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None) -> public_dot_sandbox__admin__pb2.SetSandboxLeaseSettingsResponse:
...
class SandboxAdminServiceSync(Protocol):
    ...
    def get_sandbox_lease_settings(self, request: public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsRequest, ctx: RequestContext) -> public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')

    def set_sandbox_lease_settings(self, request: public_dot_sandbox__admin__pb2.SetSandboxLeaseSettingsRequest, ctx: RequestContext) -> public_dot_sandbox__admin__pb2.SetSandboxLeaseSettingsResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class SandboxAdminServiceClientSync(ConnectClientSync):
    ...
    def get_sandbox_lease_settings(self, request: public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None, use_get: bool=False) -> public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsResponse:
        return self.execute_unary(request=request, method=MethodInfo(name='GetSandboxLeaseSettings', service_name='textql.rpc.public.sandbox_admin.SandboxAdminService', input=public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsRequest, output=public_dot_sandbox__admin__pb2.GetSandboxLeaseSettingsResponse, idempotency_level=IdempotencyLevel.NO_SIDE_EFFECTS), headers=headers, timeout_ms=timeout_ms, use_get=use_get)

    def set_sandbox_lease_settings(self, request: public_dot_sandbox__admin__pb2.SetSandboxLeaseSettingsRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None) -> public_dot_sandbox__admin__pb2.SetSandboxLeaseSettingsResponse:
