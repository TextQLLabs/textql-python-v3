...
class MCPServerWithTools(_message.Message):
    __slots__ = ('mcp_server', 'tools', 'error', 'oauth_connected_at')
    MCP_SERVER_FIELD_NUMBER: _ClassVar[int]
    TOOLS_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    OAUTH_CONNECTED_AT_FIELD_NUMBER: _ClassVar[int]
    mcp_server: MCPServer
    tools: _containers.RepeatedCompositeFieldContainer[MCPTool]
    error: MCPError
    oauth_connected_at: _timestamp_pb2.Timestamp

    def __init__(self, mcp_server: _Optional[_Union[MCPServer, _Mapping]]=..., tools: _Optional[_Iterable[_Union[MCPTool, _Mapping]]]=..., error: _Optional[_Union[MCPError, str]]=..., oauth_connected_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
