...
class ChatService(Protocol):
    ...
    async def compact_chat(self, request: public_dot_chat__pb2.CompactChatRequest, ctx: RequestContext) -> public_dot_chat__pb2.CompactChatResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class ChatServiceClient(ConnectClient):
    ...
    async def compact_chat(self, request: public_dot_chat__pb2.CompactChatRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None) -> public_dot_chat__pb2.CompactChatResponse:
        return await self.execute_unary(request=request, method=MethodInfo(name='CompactChat', service_name='textql.rpc.public.chat.ChatService', input=public_dot_chat__pb2.CompactChatRequest, output=public_dot_chat__pb2.CompactChatResponse, idempotency_level=IdempotencyLevel.UNKNOWN), headers=headers, timeout_ms=timeout_ms)
...
class ChatServiceSync(Protocol):
    ...
    def compact_chat(self, request: public_dot_chat__pb2.CompactChatRequest, ctx: RequestContext) -> public_dot_chat__pb2.CompactChatResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class ChatServiceClientSync(ConnectClientSync):
    ...
    def compact_chat(self, request: public_dot_chat__pb2.CompactChatRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None) -> public_dot_chat__pb2.CompactChatResponse:
        return self.execute_unary(request=request, method=MethodInfo(name='CompactChat', service_name='textql.rpc.public.chat.ChatService', input=public_dot_chat__pb2.CompactChatRequest, output=public_dot_chat__pb2.CompactChatResponse, idempotency_level=IdempotencyLevel.UNKNOWN), headers=headers, timeout_ms=timeout_ms)
