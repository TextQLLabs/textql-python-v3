...
class PublicAuthService(Protocol):
    ...
    async def update_member_theme(self, request: public_dot_auth__pb2.UpdateMemberThemeRequest, ctx: RequestContext) -> public_dot_auth__pb2.UpdateMemberThemeResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class PublicAuthServiceClient(ConnectClient):
    ...
    async def update_member_theme(self, request: public_dot_auth__pb2.UpdateMemberThemeRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None) -> public_dot_auth__pb2.UpdateMemberThemeResponse:
        return await self.execute_unary(request=request, method=MethodInfo(name='UpdateMemberTheme', service_name='textql.rpc.public.auth.PublicAuthService', input=public_dot_auth__pb2.UpdateMemberThemeRequest, output=public_dot_auth__pb2.UpdateMemberThemeResponse, idempotency_level=IdempotencyLevel.UNKNOWN), headers=headers, timeout_ms=timeout_ms)
...
class PublicAuthServiceSync(Protocol):
    ...
    def update_member_theme(self, request: public_dot_auth__pb2.UpdateMemberThemeRequest, ctx: RequestContext) -> public_dot_auth__pb2.UpdateMemberThemeResponse:
        raise ConnectError(Code.UNIMPLEMENTED, 'Not implemented')
...
class PublicAuthServiceClientSync(ConnectClientSync):
    ...
    def update_member_theme(self, request: public_dot_auth__pb2.UpdateMemberThemeRequest, *, headers: Headers | Mapping[str, str] | None=None, timeout_ms: int | None=None) -> public_dot_auth__pb2.UpdateMemberThemeResponse:
        return self.execute_unary(request=request, method=MethodInfo(name='UpdateMemberTheme', service_name='textql.rpc.public.auth.PublicAuthService', input=public_dot_auth__pb2.UpdateMemberThemeRequest, output=public_dot_auth__pb2.UpdateMemberThemeResponse, idempotency_level=IdempotencyLevel.UNKNOWN), headers=headers, timeout_ms=timeout_ms)
