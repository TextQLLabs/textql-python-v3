...
class OntologySummary(_message.Message):
    __slots__ = ('id', 'name', 'description', 'connector_id', 'connector_name', 'is_example')
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    CONNECTOR_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[int]=..., name: _Optional[str]=..., description: _Optional[str]=..., connector_id: _Optional[int]=..., connector_name: _Optional[str]=..., is_example: bool=...) -> None:
        ...

class GetOntologiesSummaryRequest(_message.Message):
    __slots__ = ('include_examples',)
    INCLUDE_EXAMPLES_FIELD_NUMBER: _ClassVar[int]
    include_examples: bool
...
class GetOntologiesSummaryResponse(_message.Message):
    __slots__ = ('ontologies',)
    ONTOLOGIES_FIELD_NUMBER: _ClassVar[int]
    ontologies: _containers.RepeatedCompositeFieldContainer[OntologySummary]

    def __init__(self, ontologies: _Optional[_Iterable[_Union[OntologySummary, _Mapping]]]=...) -> None:
        ...
...
class UpdateObjectResponse(_message.Message):
    __slots__ = ('object', 'attributes', 'deleted_metric_ids', 'deleted_relation_ids')
    OBJECT_FIELD_NUMBER: _ClassVar[int]
    ATTRIBUTES_FIELD_NUMBER: _ClassVar[int]
    DELETED_METRIC_IDS_FIELD_NUMBER: _ClassVar[int]
    DELETED_RELATION_IDS_FIELD_NUMBER: _ClassVar[int]
    object: OntologyObject
    attributes: _containers.RepeatedCompositeFieldContainer[OntologyAttribute]
    deleted_metric_ids: _containers.RepeatedScalarFieldContainer[str]
    deleted_relation_ids: _containers.RepeatedScalarFieldContainer[str]

    def __init__(self, object: _Optional[_Union[OntologyObject, _Mapping]]=..., attributes: _Optional[_Iterable[_Union[OntologyAttribute, _Mapping]]]=..., deleted_metric_ids: _Optional[_Iterable[str]]=..., deleted_relation_ids: _Optional[_Iterable[str]]=...) -> None:
        ...
...
class CreateFilterRuleRequest(_message.Message):
    __slots__ = ('ontology_id', 'attribute_id', 'rule_value')
    ONTOLOGY_ID_FIELD_NUMBER: _ClassVar[int]
    ATTRIBUTE_ID_FIELD_NUMBER: _ClassVar[int]
    RULE_VALUE_FIELD_NUMBER: _ClassVar[int]
    ontology_id: int
    attribute_id: str
    rule_value: str

    def __init__(self, ontology_id: _Optional[int]=..., attribute_id: _Optional[str]=..., rule_value: _Optional[str]=...) -> None:
        ...
...
class GetFilterRuleResponse(_message.Message):
    __slots__ = ('has_rule', 'rule_value')
    HAS_RULE_FIELD_NUMBER: _ClassVar[int]
    RULE_VALUE_FIELD_NUMBER: _ClassVar[int]
    has_rule: bool
    rule_value: str

    def __init__(self, has_rule: bool=..., rule_value: _Optional[str]=...) -> None:
        ...
