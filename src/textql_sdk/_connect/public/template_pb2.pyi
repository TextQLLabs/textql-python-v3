...
class PlaybookTemplateData(_message.Message):
    __slots__ = ('id', 'playbook_header', 'entries', 'org_id', 'created_at', 'updated_at', 'execution_status', 'last_execution_started_at', 'last_execution_completed_at', 'last_execution_error', 'chat_id')
    ID_FIELD_NUMBER: _ClassVar[int]
...
class SearchPlaybookTemplateDataRequest(_message.Message):
    __slots__ = ('playbook_header', 'filters', 'limit', 'offset')
    PLAYBOOK_HEADER_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    LIMIT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
    playbook_header: str
    filters: _containers.RepeatedCompositeFieldContainer[_playbook_pb2.FilterCondition]
    limit: int
    offset: int

    def __init__(self, playbook_header: _Optional[str]=..., filters: _Optional[_Iterable[_Union[_playbook_pb2.FilterCondition, _Mapping]]]=..., limit: _Optional[int]=..., offset: _Optional[int]=...) -> None:
        ...

class SearchPlaybookTemplateDataResponse(_message.Message):
    __slots__ = ('data_rows', 'total_count', 'offset', 'limit', 'has_more')
    DATA_ROWS_FIELD_NUMBER: _ClassVar[int]
    TOTAL_COUNT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
