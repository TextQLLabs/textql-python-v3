...
class Organization(_message.Message):
    ...
    SANDBOX_LEASE_CONFIG_ENABLED_FIELD_NUMBER: _ClassVar[int]
    ...
    APP_WRITEBACK_AUTO_APPROVE_ENABLED_FIELD_NUMBER: _ClassVar[int]
    SUBAGENTS_ENABLED_FIELD_NUMBER: _ClassVar[int]
    org_id: str
    slack_team_id: str
    slack_key: str
    ...
    sandbox_lease_config_enabled: bool
