...
class SandboxCapabilities(BaseSDK):
    def deliver(
        ...
        *,
        ...
        attachment_urls: Optional[Iterable[str]] = None,
        recipient_emails: Optional[Iterable[str]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SandboxCapabilityServiceDeliverResponse:
        r"""Deliver
        ...
        request = models.SandboxCapabilityServiceDeliverRequest(
            ...
            body=models.TextqlRPCPublicSandboxCapabilitySandboxDeliverRequest(
                ...
                attachment_urls=utils.unmarshal(attachment_urls, Optional[List[str]]),
                recipient_emails=utils.unmarshal(recipient_emails, Optional[List[str]]),
            ),
        )

        req = self._build_request(
            method="POST",
            path="/textql.rpc.public.sandbox_capability.SandboxCapabilityService/Deliver",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.TextqlRPCPublicSandboxCapabilitySandboxDeliverRequest,
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="SandboxCapabilityService_Deliver",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.TextqlRPCPublicSandboxCapabilitySandboxDeliverResponse, http_res
            )
