...
class RBACServiceGenerateShareLinkRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacGenerateShareLinkRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceGenerateShareLinkRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacGenerateShareLinkRequest,
...
RBACServiceGenerateShareLinkResponseTypedDict = TypeAliasType(
    "RBACServiceGenerateShareLinkResponseTypedDict",
    Union[TextqlRPCPublicRbacGenerateShareLinkResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceGenerateShareLinkResponse = TypeAliasType(
    "RBACServiceGenerateShareLinkResponse",
    Union[TextqlRPCPublicRbacGenerateShareLinkResponse, ConnectError],
)


try:
    RBACServiceGenerateShareLinkRequest.model_rebuild()
except NameError:
    pass
