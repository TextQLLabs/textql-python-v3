...
class TextqlRPCPublicSecretSecretTypedDict(TypedDict):
    id: NotRequired[str]
...
class TextqlRPCPublicSecretSecret(BaseModel):
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["description", "link", "accessType"])
...
try:
    TextqlRPCPublicSecretSecret.model_rebuild()
except NameError:
    pass
