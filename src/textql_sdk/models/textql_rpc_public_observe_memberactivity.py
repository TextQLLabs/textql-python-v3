...
class TextqlRPCPublicObserveMemberActivity(BaseModel):
    ...
    daily_activity: Annotated[
        Optional[List[int]], pydantic.Field(alias="dailyActivity")
    ] = None
    ...
    last_active: Annotated[Optional[datetime], pydantic.Field(alias="lastActive")] = (
        None
    )
    r"""A Timestamp represents a point in time independent of any time zone or local
    calendar, encoded as a count of seconds and fractions of seconds at
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["memberId", "dailyActivity", "eventCount", "threadCount", "lastActive"]
        )
...
try:
    TextqlRPCPublicObserveMemberActivity.model_rebuild()
except NameError:
    pass
