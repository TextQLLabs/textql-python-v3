...
class TextqlRPCPublicRbacUpdateObjectAccessRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["accessId", "accessType", "expiresAt"])
...
try:
    TextqlRPCPublicRbacUpdateObjectAccessRequest.model_rebuild()
except NameError:
    pass
