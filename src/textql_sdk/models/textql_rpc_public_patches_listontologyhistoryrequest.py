...
class TextqlRPCPublicPatchesListOntologyHistoryRequestTypedDict(TypedDict):
    page_size: NotRequired[Nullable[int]]
    page_token: NotRequired[Nullable[str]]
    path: NotRequired[Nullable[str]]


class TextqlRPCPublicPatchesListOntologyHistoryRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["pageSize", "pageToken", "path"])
        nullable_fields = set(["pageSize", "pageToken", "path"])
...
try:
    TextqlRPCPublicPatchesListOntologyHistoryRequest.model_rebuild()
except NameError:
    pass
