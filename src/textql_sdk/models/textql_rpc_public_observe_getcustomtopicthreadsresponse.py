...
from .textql_rpc_public_observe_customtopicthread import (
    TextqlRPCPublicObserveCustomTopicThread,
    TextqlRPCPublicObserveCustomTopicThreadTypedDict,
)
import pydantic
...
class TextqlRPCPublicObserveGetCustomTopicThreadsResponse(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["threads", "nextPageToken"])
...
try:
    TextqlRPCPublicObserveGetCustomTopicThreadsResponse.model_rebuild()
except NameError:
    pass
