...
from .textql_rpc_public_patches_approvalruleinput import (
...
class TextqlRPCPublicPatchesCreateApprovalRuleRequestTypedDict(TypedDict):
    rule: NotRequired[TextqlRPCPublicPatchesApprovalRuleInputTypedDict]


class TextqlRPCPublicPatchesCreateApprovalRuleRequest(BaseModel):
