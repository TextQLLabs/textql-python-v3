...
class TextqlRPCPublicObserveGetAccessMethodStatsRequestTypedDict(TypedDict):
...
class TextqlRPCPublicObserveGetAccessMethodStatsRequest(BaseModel):
...
try:
    TextqlRPCPublicObserveGetAccessMethodStatsRequest.model_rebuild()
except NameError:
    pass
