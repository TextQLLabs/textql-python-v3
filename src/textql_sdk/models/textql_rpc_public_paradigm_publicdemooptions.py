...
class TextqlRPCPublicParadigmPublicDemoOptionsTypedDict(TypedDict):
    connector_id: NotRequired[int]


class TextqlRPCPublicParadigmPublicDemoOptions(BaseModel):
...
try:
    TextqlRPCPublicParadigmPublicDemoOptions.model_rebuild()
except NameError:
    pass
