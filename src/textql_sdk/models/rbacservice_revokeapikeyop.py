...
class RBACServiceRevokeAPIKeyRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacRevokeAPIKeyRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceRevokeAPIKeyRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacRevokeAPIKeyRequest,
...
RBACServiceRevokeAPIKeyResponseTypedDict = TypeAliasType(
    "RBACServiceRevokeAPIKeyResponseTypedDict",
    Union[TextqlRPCPublicRbacRevokeAPIKeyResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceRevokeAPIKeyResponse = TypeAliasType(
    "RBACServiceRevokeAPIKeyResponse",
    Union[TextqlRPCPublicRbacRevokeAPIKeyResponse, ConnectError],
)


try:
    RBACServiceRevokeAPIKeyRequest.model_rebuild()
except NameError:
    pass
