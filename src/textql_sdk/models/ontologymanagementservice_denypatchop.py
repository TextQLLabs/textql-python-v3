...
class OntologyManagementServiceDenyPatchRequestTypedDict(TypedDict):
    body: TextqlRPCPublicPatchesDenyPatchRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class OntologyManagementServiceDenyPatchRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesDenyPatchRequest,
...
OntologyManagementServiceDenyPatchResponseTypedDict = TypeAliasType(
    "OntologyManagementServiceDenyPatchResponseTypedDict",
    Union[GoogleProtobufEmptyTypedDict, ConnectErrorTypedDict],
)


OntologyManagementServiceDenyPatchResponse = TypeAliasType(
...
try:
    OntologyManagementServiceDenyPatchRequest.model_rebuild()
except NameError:
    pass
