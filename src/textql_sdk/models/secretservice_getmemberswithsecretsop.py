...
class SecretServiceGetMembersWithSecretsRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretGetMembersWithSecretsRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServiceGetMembersWithSecretsRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretGetMembersWithSecretsRequest,
...
SecretServiceGetMembersWithSecretsResponseTypedDict = TypeAliasType(
...
SecretServiceGetMembersWithSecretsResponse = TypeAliasType(
    "SecretServiceGetMembersWithSecretsResponse",
    Union[TextqlRPCPublicSecretGetMembersWithSecretsResponse, ConnectError],
)


try:
    SecretServiceGetMembersWithSecretsRequest.model_rebuild()
except NameError:
    pass
