...
class RBACServiceShareObjectWithRoleRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacShareObjectWithRoleRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceShareObjectWithRoleRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacShareObjectWithRoleRequest,
...
RBACServiceShareObjectWithRoleResponseTypedDict = TypeAliasType(
    "RBACServiceShareObjectWithRoleResponseTypedDict",
    Union[
        TextqlRPCPublicRbacShareObjectWithRoleResponseTypedDict, ConnectErrorTypedDict
    ],
)


RBACServiceShareObjectWithRoleResponse = TypeAliasType(
    "RBACServiceShareObjectWithRoleResponse",
    Union[TextqlRPCPublicRbacShareObjectWithRoleResponse, ConnectError],
)


try:
    RBACServiceShareObjectWithRoleRequest.model_rebuild()
except NameError:
    pass
