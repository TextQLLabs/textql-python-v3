...
from .textql_rpc_public_patches_dailyfileusage import (
    TextqlRPCPublicPatchesDailyFileUsage,
    TextqlRPCPublicPatchesDailyFileUsageTypedDict,
)
...
class TextqlRPCPublicPatchesGetUsageDetailsForFileResponseTypedDict(TypedDict):
...
class TextqlRPCPublicPatchesGetUsageDetailsForFileResponse(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["lastUsed", "days"])
...
try:
    TextqlRPCPublicPatchesGetUsageDetailsForFileResponse.model_rebuild()
except NameError:
    pass
