...
class TextqlRPCPublicPatchesApprovePatchRequestTypedDict(TypedDict):
    patch_id: NotRequired[str]
    expected_git_ref: NotRequired[str]


class TextqlRPCPublicPatchesApprovePatchRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["patchId", "expectedGitRef"])
...
try:
    TextqlRPCPublicPatchesApprovePatchRequest.model_rebuild()
except NameError:
    pass
