...
class RBACServiceApproveAccessRequestRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacApproveAccessRequestRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceApproveAccessRequestRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacApproveAccessRequestRequest,
...
RBACServiceApproveAccessRequestResponseTypedDict = TypeAliasType(
    "RBACServiceApproveAccessRequestResponseTypedDict",
    Union[
        TextqlRPCPublicRbacApproveAccessRequestResponseTypedDict, ConnectErrorTypedDict
    ],
)


RBACServiceApproveAccessRequestResponse = TypeAliasType(
    "RBACServiceApproveAccessRequestResponse",
    Union[TextqlRPCPublicRbacApproveAccessRequestResponse, ConnectError],
)


try:
    RBACServiceApproveAccessRequestRequest.model_rebuild()
except NameError:
    pass
