...
class TextqlRPCPublicConnectorGoogleCalendarMetadataTypedDict(TypedDict):
...
class TextqlRPCPublicConnectorGoogleCalendarMetadata(BaseModel):
...
try:
    TextqlRPCPublicConnectorGoogleCalendarMetadata.model_rebuild()
except NameError:
    pass
