...
class OntologyManagementServiceListGoldenFilesRequestTypedDict(TypedDict):
...
class OntologyManagementServiceListGoldenFilesRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesListGoldenFilesRequest,
...
OntologyManagementServiceListGoldenFilesResponseTypedDict = TypeAliasType(
    "OntologyManagementServiceListGoldenFilesResponseTypedDict",
    Union[
...
OntologyManagementServiceListGoldenFilesResponse = TypeAliasType(
...
try:
    OntologyManagementServiceListGoldenFilesRequest.model_rebuild()
except NameError:
    pass
