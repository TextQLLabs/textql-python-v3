...
class TextqlRPCPublicSandboxCapabilitySandboxSendNotifyRequestTypedDict(TypedDict):
...
class TextqlRPCPublicSandboxCapabilitySandboxSendNotifyRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["name", "subject", "body", "parameters"])
