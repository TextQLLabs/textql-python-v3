...
class TextqlRPCPublicPlaybookDeletePlaybookResponseTypedDict(TypedDict):
...
class TextqlRPCPublicPlaybookDeletePlaybookResponse(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["playbookId", "deletedAt"])
...
try:
    TextqlRPCPublicPlaybookDeletePlaybookResponse.model_rebuild()
except NameError:
    pass
