...
class SecretServicePutSecretRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretPutSecretRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServicePutSecretRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretPutSecretRequest,
...
SecretServicePutSecretResponseTypedDict = TypeAliasType(
    "SecretServicePutSecretResponseTypedDict",
    Union[TextqlRPCPublicSecretPutSecretResponseTypedDict, ConnectErrorTypedDict],
)


SecretServicePutSecretResponse = TypeAliasType(
    "SecretServicePutSecretResponse",
    Union[TextqlRPCPublicSecretPutSecretResponse, ConnectError],
)


try:
    SecretServicePutSecretRequest.model_rebuild()
except NameError:
    pass
