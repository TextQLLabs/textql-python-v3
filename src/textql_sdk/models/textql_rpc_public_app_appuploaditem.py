...
class TextqlRPCPublicAppAppUploadItemTypedDict(TypedDict):
    ...
    raw_only: NotRequired[bool]


class TextqlRPCPublicAppAppUploadItem(BaseModel):
    ...
    library_path: Annotated[Optional[str], pydantic.Field(alias="libraryPath")] = None

    table_count: Annotated[Optional[int], pydantic.Field(alias="tableCount")] = None

    raw_only: Annotated[Optional[bool], pydantic.Field(alias="rawOnly")] = None
...
try:
    TextqlRPCPublicAppAppUploadItem.model_rebuild()
except NameError:
    pass
