...
class OntologyManagementServiceGetSkillRequestTypedDict(TypedDict):
    body: TextqlRPCPublicPatchesGetSkillRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class OntologyManagementServiceGetSkillRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesGetSkillRequest,
...
OntologyManagementServiceGetSkillResponseTypedDict = TypeAliasType(
    "OntologyManagementServiceGetSkillResponseTypedDict",
    Union[TextqlRPCPublicPatchesGetSkillResponseTypedDict, ConnectErrorTypedDict],
)


OntologyManagementServiceGetSkillResponse = TypeAliasType(
    "OntologyManagementServiceGetSkillResponse",
    Union[TextqlRPCPublicPatchesGetSkillResponse, ConnectError],
)


try:
    OntologyManagementServiceGetSkillRequest.model_rebuild()
except NameError:
    pass
