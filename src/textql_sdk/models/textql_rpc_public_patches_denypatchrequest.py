...
class TextqlRPCPublicPatchesDenyPatchRequestTypedDict(TypedDict):
    patch_id: NotRequired[str]
    expected_git_ref: NotRequired[str]


class TextqlRPCPublicPatchesDenyPatchRequest(BaseModel):
...
try:
    TextqlRPCPublicPatchesDenyPatchRequest.model_rebuild()
except NameError:
    pass
