...
class TextqlRPCPublicRbacGenerateShareLinkRequestTypedDict(TypedDict):
    object_type: NotRequired[str]
    object_id: NotRequired[str]


class TextqlRPCPublicRbacGenerateShareLinkRequest(BaseModel):
...
try:
    TextqlRPCPublicRbacGenerateShareLinkRequest.model_rebuild()
except NameError:
    pass
