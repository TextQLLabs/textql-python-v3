...
class RBACServiceRejectAccessRequestRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacRejectAccessRequestRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceRejectAccessRequestRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacRejectAccessRequestRequest,
...
RBACServiceRejectAccessRequestResponseTypedDict = TypeAliasType(
    "RBACServiceRejectAccessRequestResponseTypedDict",
    Union[
        TextqlRPCPublicRbacRejectAccessRequestResponseTypedDict, ConnectErrorTypedDict
    ],
)


RBACServiceRejectAccessRequestResponse = TypeAliasType(
    "RBACServiceRejectAccessRequestResponse",
    Union[TextqlRPCPublicRbacRejectAccessRequestResponse, ConnectError],
)


try:
    RBACServiceRejectAccessRequestRequest.model_rebuild()
except NameError:
    pass
