...
from .textql_rpc_public_sandbox_capability_sandboxsendnotifyrequest import (
...
class SandboxCapabilityServiceSendNotifyRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxCapabilitySandboxSendNotifyRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxCapabilityServiceSendNotifyRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxCapabilitySandboxSendNotifyRequest,
...
SandboxCapabilityServiceSendNotifyResponseTypedDict = TypeAliasType(
...
SandboxCapabilityServiceSendNotifyResponse = TypeAliasType(
    "SandboxCapabilityServiceSendNotifyResponse",
    Union[TextqlRPCPublicSandboxCapabilitySandboxSendNotifyResponse, ConnectError],
)


try:
    SandboxCapabilityServiceSendNotifyRequest.model_rebuild()
except NameError:
    pass
