...
class SecretServiceListSecretsRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretListSecretsRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServiceListSecretsRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretListSecretsRequest,
...
SecretServiceListSecretsResponseTypedDict = TypeAliasType(
    "SecretServiceListSecretsResponseTypedDict",
    Union[TextqlRPCPublicSecretListSecretsResponseTypedDict, ConnectErrorTypedDict],
)


SecretServiceListSecretsResponse = TypeAliasType(
    "SecretServiceListSecretsResponse",
    Union[TextqlRPCPublicSecretListSecretsResponse, ConnectError],
)


try:
    SecretServiceListSecretsRequest.model_rebuild()
except NameError:
    pass
