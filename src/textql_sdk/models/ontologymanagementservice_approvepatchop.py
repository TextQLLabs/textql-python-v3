...
class OntologyManagementServiceApprovePatchRequestTypedDict(TypedDict):
...
class OntologyManagementServiceApprovePatchRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesApprovePatchRequest,
...
try:
    OntologyManagementServiceApprovePatchRequest.model_rebuild()
except NameError:
    pass
