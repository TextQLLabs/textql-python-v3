...
from .textql_rpc_public_rbac_listserviceaccountsresponse import (
...
class RBACServiceListServiceAccountsRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacListServiceAccountsRequest,
...
RBACServiceListServiceAccountsResponseTypedDict = TypeAliasType(
    "RBACServiceListServiceAccountsResponseTypedDict",
    Union[
        TextqlRPCPublicRbacListServiceAccountsResponseTypedDict, ConnectErrorTypedDict
    ],
)


RBACServiceListServiceAccountsResponse = TypeAliasType(
    "RBACServiceListServiceAccountsResponse",
    Union[TextqlRPCPublicRbacListServiceAccountsResponse, ConnectError],
)


try:
    RBACServiceListServiceAccountsRequest.model_rebuild()
except NameError:
    pass
