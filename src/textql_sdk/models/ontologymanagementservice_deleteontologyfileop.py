...
from .textql_rpc_public_patches_deleteontologyfilerequest import (
...
class OntologyManagementServiceDeleteOntologyFileRequestTypedDict(TypedDict):
    body: TextqlRPCPublicPatchesDeleteOntologyFileRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class OntologyManagementServiceDeleteOntologyFileRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesDeleteOntologyFileRequest,
...
OntologyManagementServiceDeleteOntologyFileResponseTypedDict = TypeAliasType(
    "OntologyManagementServiceDeleteOntologyFileResponseTypedDict",
    Union[GoogleProtobufEmptyTypedDict, ConnectErrorTypedDict],
)


OntologyManagementServiceDeleteOntologyFileResponse = TypeAliasType(
...
try:
    OntologyManagementServiceDeleteOntologyFileRequest.model_rebuild()
except NameError:
    pass
