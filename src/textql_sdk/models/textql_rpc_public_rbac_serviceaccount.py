...
class TextqlRPCPublicRbacServiceAccountTypedDict(TypedDict):
...
class TextqlRPCPublicRbacServiceAccount(BaseModel):
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["description", "ownerMemberId", "agentId"])
...
try:
    TextqlRPCPublicRbacServiceAccount.model_rebuild()
except NameError:
    pass
