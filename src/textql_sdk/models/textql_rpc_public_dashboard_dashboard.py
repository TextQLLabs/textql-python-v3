...
from .textql_rpc_public_dashboard_dashboardcreator import (
    TextqlRPCPublicDashboardDashboardCreator,
    TextqlRPCPublicDashboardDashboardCreatorTypedDict,
)
...
class TextqlRPCPublicDashboardDashboardTypedDict(TypedDict):
    id: NotRequired[str]
    ...
    r"""URL for serving HTML dashboards"""
    ...
    """
    creator: NotRequired[TextqlRPCPublicDashboardDashboardCreatorTypedDict]
    streamlit_url: NotRequired[Nullable[str]]
    r"""Active URL if spawned"""
    status: NotRequired[TextqlRPCPublicDashboardDashboardStatus]
    ...
    r"""per-caller pin state (enriched, not stored on the dashboard)"""


class TextqlRPCPublicDashboardDashboard(BaseModel):
    ...
    creator: Optional[TextqlRPCPublicDashboardDashboardCreator] = None
    ...
    status: Optional[TextqlRPCPublicDashboardDashboardStatus] = None
    ...
    latest_scheduled_run_at: Annotated[
        Optional[datetime], pydantic.Field(alias="latestScheduledRunAt")
    ] = None
    r"""A Timestamp represents a point in time independent of any time zone or local
    calendar, encoded as a count of seconds and fractions of seconds at
    nanosecond resolution. The count is relative to an epoch at UTC midnight on
...
try:
    TextqlRPCPublicDashboardDashboard.model_rebuild()
except NameError:
    pass
