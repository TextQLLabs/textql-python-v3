...
class SecretServiceDeleteAPIRevisionRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretDeleteAPIRevisionRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServiceDeleteAPIRevisionRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretDeleteAPIRevisionRequest,
...
SecretServiceDeleteAPIRevisionResponseTypedDict = TypeAliasType(
    "SecretServiceDeleteAPIRevisionResponseTypedDict",
    Union[
        TextqlRPCPublicSecretDeleteAPIRevisionResponseTypedDict, ConnectErrorTypedDict
    ],
)


SecretServiceDeleteAPIRevisionResponse = TypeAliasType(
    "SecretServiceDeleteAPIRevisionResponse",
    Union[TextqlRPCPublicSecretDeleteAPIRevisionResponse, ConnectError],
)


try:
    SecretServiceDeleteAPIRevisionRequest.model_rebuild()
except NameError:
    pass
