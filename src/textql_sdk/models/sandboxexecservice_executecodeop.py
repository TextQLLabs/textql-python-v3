...
class SandboxExecServiceExecuteCodeRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxExecSandboxExecuteCodeRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxExecServiceExecuteCodeRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxExecSandboxExecuteCodeRequest,
...
SandboxExecServiceExecuteCodeResponseTypedDict = TypeAliasType(
...
SandboxExecServiceExecuteCodeResponse = TypeAliasType(
    "SandboxExecServiceExecuteCodeResponse",
    Union[ConnectError, TextqlRPCPublicSandboxExecSandboxExecuteCodeResponse],
)


try:
    SandboxExecServiceExecuteCodeRequest.model_rebuild()
except NameError:
    pass
