...
class OntologyManagementServiceListContextPatchAutoApproveRulesRequestTypedDict(
    TypedDict
):
...
class OntologyManagementServiceListContextPatchAutoApproveRulesRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesListContextPatchAutoApproveRulesRequest,
...
OntologyManagementServiceListContextPatchAutoApproveRulesResponseTypedDict = (
    TypeAliasType(
        "OntologyManagementServiceListContextPatchAutoApproveRulesResponseTypedDict",
        Union[
            TextqlRPCPublicPatchesListContextPatchAutoApproveRulesResponseTypedDict,
...
OntologyManagementServiceListContextPatchAutoApproveRulesResponse = TypeAliasType(
    "OntologyManagementServiceListContextPatchAutoApproveRulesResponse",
    Union[TextqlRPCPublicPatchesListContextPatchAutoApproveRulesResponse, ConnectError],
)


try:
    OntologyManagementServiceListContextPatchAutoApproveRulesRequest.model_rebuild()
except NameError:
    pass
