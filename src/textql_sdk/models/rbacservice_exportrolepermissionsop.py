...
class RBACServiceExportRolePermissionsRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacExportRolePermissionsRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceExportRolePermissionsRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacExportRolePermissionsRequest,
...
RBACServiceExportRolePermissionsResponseTypedDict = TypeAliasType(
    "RBACServiceExportRolePermissionsResponseTypedDict",
    Union[
        TextqlRPCPublicRbacExportRolePermissionsResponseTypedDict, ConnectErrorTypedDict
    ],
)


RBACServiceExportRolePermissionsResponse = TypeAliasType(
    "RBACServiceExportRolePermissionsResponse",
    Union[TextqlRPCPublicRbacExportRolePermissionsResponse, ConnectError],
)


try:
    RBACServiceExportRolePermissionsRequest.model_rebuild()
except NameError:
    pass
