...
class SettingsServiceGetOrganizationSettingsRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSettingsGetOrganizationSettingsRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SettingsServiceGetOrganizationSettingsRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSettingsGetOrganizationSettingsRequest,
...
SettingsServiceGetOrganizationSettingsResponseTypedDict = TypeAliasType(
...
SettingsServiceGetOrganizationSettingsResponse = TypeAliasType(
    "SettingsServiceGetOrganizationSettingsResponse",
    Union[TextqlRPCPublicSettingsGetOrganizationSettingsResponse, ConnectError],
)


try:
    SettingsServiceGetOrganizationSettingsRequest.model_rebuild()
except NameError:
    pass
