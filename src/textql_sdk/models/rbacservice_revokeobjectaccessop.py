...
class RBACServiceRevokeObjectAccessRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacRevokeObjectAccessRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceRevokeObjectAccessRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacRevokeObjectAccessRequest,
...
RBACServiceRevokeObjectAccessResponseTypedDict = TypeAliasType(
    "RBACServiceRevokeObjectAccessResponseTypedDict",
    Union[
        TextqlRPCPublicRbacRevokeObjectAccessResponseTypedDict, ConnectErrorTypedDict
    ],
)


RBACServiceRevokeObjectAccessResponse = TypeAliasType(
    "RBACServiceRevokeObjectAccessResponse",
    Union[TextqlRPCPublicRbacRevokeObjectAccessResponse, ConnectError],
)


try:
    RBACServiceRevokeObjectAccessRequest.model_rebuild()
except NameError:
    pass
