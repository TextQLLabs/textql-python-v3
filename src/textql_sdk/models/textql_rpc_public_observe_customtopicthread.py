...
class TextqlRPCPublicObserveCustomTopicThreadTypedDict(TypedDict):
...
class TextqlRPCPublicObserveCustomTopicThread(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["chatId", "title", "memberId", "taggedBy", "taggedAt"])
...
try:
    TextqlRPCPublicObserveCustomTopicThread.model_rebuild()
except NameError:
    pass
