...
class LibraryServiceDenyPatchRequestTypedDict(TypedDict):
    body: TextqlRPCPublicPatchesDenyPatchRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class LibraryServiceDenyPatchRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesDenyPatchRequest,
...
LibraryServiceDenyPatchResponseTypedDict = TypeAliasType(
    "LibraryServiceDenyPatchResponseTypedDict",
    Union[GoogleProtobufEmptyTypedDict, ConnectErrorTypedDict],
)


LibraryServiceDenyPatchResponse = TypeAliasType(
    "LibraryServiceDenyPatchResponse", Union[GoogleProtobufEmpty, ConnectError]
)


try:
    LibraryServiceDenyPatchRequest.model_rebuild()
except NameError:
    pass
