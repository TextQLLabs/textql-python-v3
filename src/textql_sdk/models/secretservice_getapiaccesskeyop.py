...
from .textql_rpc_public_secret_getapiaccesskeyrequest import (
...
class SecretServiceGetAPIAccessKeyRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretGetAPIAccessKeyRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServiceGetAPIAccessKeyRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretGetAPIAccessKeyRequest,
...
SecretServiceGetAPIAccessKeyResponseTypedDict = TypeAliasType(
    "SecretServiceGetAPIAccessKeyResponseTypedDict",
    Union[TextqlRPCPublicSecretGetAPIAccessKeyResponseTypedDict, ConnectErrorTypedDict],
)


SecretServiceGetAPIAccessKeyResponse = TypeAliasType(
    "SecretServiceGetAPIAccessKeyResponse",
    Union[TextqlRPCPublicSecretGetAPIAccessKeyResponse, ConnectError],
)


try:
    SecretServiceGetAPIAccessKeyRequest.model_rebuild()
except NameError:
    pass
