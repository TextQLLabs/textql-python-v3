...
class TextqlRPCPublicChatAutoAttachedLibraryFileTypedDict(TypedDict):
    ...
    """
    last_pulled_at: NotRequired[datetime]
    r"""A Timestamp represents a point in time independent of any time zone or local
    calendar, encoded as a count of seconds and fractions of seconds at
    nanosecond resolution. The count is relative to an epoch at UTC midnight on
    January 1, 1970, in the proleptic Gregorian calendar which extends the
...
class TextqlRPCPublicChatAutoAttachedLibraryFile(BaseModel):
    ...
    last_pulled_at: Annotated[
        Optional[datetime], pydantic.Field(alias="lastPulledAt")
    ] = None
    r"""A Timestamp represents a point in time independent of any time zone or local
    calendar, encoded as a count of seconds and fractions of seconds at
    nanosecond resolution. The count is relative to an epoch at UTC midnight on
    ...
    def serialize_model(self, handler):
        optional_fields = set(["path", "pullCount", "firstPulledAt", "lastPulledAt"])
...
try:
    TextqlRPCPublicChatAutoAttachedLibraryFile.model_rebuild()
except NameError:
    pass
