...
class TextqlRPCPublicRbacCallerCredential(BaseModel):
    ...
    api_key_name: Annotated[
        OptionalNullable[str], pydantic.Field(alias="apiKeyName")
    ] = UNSET
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["apiKeyId", "apiKeyName", "apiKeyShort", "clientId"])
...
try:
    TextqlRPCPublicRbacCallerCredential.model_rebuild()
except NameError:
    pass
