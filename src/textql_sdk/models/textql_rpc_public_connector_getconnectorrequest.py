...
class TextqlRPCPublicConnectorGetConnectorRequestTypedDict(TypedDict):
    connector_id: NotRequired[int]


class TextqlRPCPublicConnectorGetConnectorRequest(BaseModel):
...
try:
    TextqlRPCPublicConnectorGetConnectorRequest.model_rebuild()
except NameError:
    pass
