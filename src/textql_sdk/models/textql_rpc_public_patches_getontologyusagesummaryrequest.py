...
class TextqlRPCPublicPatchesGetOntologyUsageSummaryRequestTypedDict(TypedDict):
...
class TextqlRPCPublicPatchesGetOntologyUsageSummaryRequest(BaseModel):
...
try:
    TextqlRPCPublicPatchesGetOntologyUsageSummaryRequest.model_rebuild()
except NameError:
    pass
