...
class ObservabilityServiceGetMemberSignalTrendRequestTypedDict(TypedDict):
    body: TextqlRPCPublicObserveGetMemberSignalTrendRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class ObservabilityServiceGetMemberSignalTrendRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicObserveGetMemberSignalTrendRequest,
...
ObservabilityServiceGetMemberSignalTrendResponseTypedDict = TypeAliasType(
...
ObservabilityServiceGetMemberSignalTrendResponse = TypeAliasType(
    "ObservabilityServiceGetMemberSignalTrendResponse",
    Union[TextqlRPCPublicObserveGetMemberSignalTrendResponse, ConnectError],
)


try:
    ObservabilityServiceGetMemberSignalTrendRequest.model_rebuild()
except NameError:
    pass
