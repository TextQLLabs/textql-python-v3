...
class TextqlRPCPublicRbacRoleTypedDict(TypedDict):
    ...
    """
    default_model_id: NotRequired[Nullable[int]]
...
class TextqlRPCPublicRbacRole(BaseModel):
    ...
    default_model_id: Annotated[
        OptionalNullable[int], pydantic.Field(alias="defaultModelId")
    ] = UNSET
    ...
    allow_model_choice: Annotated[
        OptionalNullable[bool], pydantic.Field(alias="allowModelChoice")
    ] = UNSET
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["defaultModelId", "allowModelChoice"])
...
try:
    TextqlRPCPublicRbacRole.model_rebuild()
except NameError:
    pass
