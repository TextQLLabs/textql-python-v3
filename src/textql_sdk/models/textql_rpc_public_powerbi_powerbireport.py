...
class TextqlRPCPublicPowerbiPowerBIReportTypedDict(TypedDict):
    id: NotRequired[str]
...
class TextqlRPCPublicPowerbiPowerBIReport(BaseModel):
...
try:
    TextqlRPCPublicPowerbiPowerBIReport.model_rebuild()
except NameError:
    pass
