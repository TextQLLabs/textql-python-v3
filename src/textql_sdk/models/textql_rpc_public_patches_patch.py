...
from .textql_rpc_public_patches_patchcodeownerstatus import (
    TextqlRPCPublicPatchesPatchCodeownerStatus,
    TextqlRPCPublicPatchesPatchCodeownerStatusTypedDict,
)
...
class TextqlRPCPublicPatchesPatchTypedDict(TypedDict):
    id: NotRequired[str]
    ...
    """
    author_email: NotRequired[Nullable[str]]
...
class TextqlRPCPublicPatchesPatch(BaseModel):
    ...
    author_id: Annotated[Optional[str], pydantic.Field(alias="authorId")] = None
    ...
    ai_generated: Annotated[Optional[bool], pydantic.Field(alias="aiGenerated")] = None
    ...
    author_email: Annotated[
        OptionalNullable[str], pydantic.Field(alias="authorEmail")
    ] = UNSET

    author_name: Annotated[
        OptionalNullable[str], pydantic.Field(alias="authorName")
    ] = UNSET
    ...
    code_owner_status: Annotated[
        ...
        pydantic.Field(alias="codeOwnerStatus"),
    ] = None

    requested_reviewer_member_ids: Annotated[
...
try:
    TextqlRPCPublicPatchesPatch.model_rebuild()
except NameError:
    pass
