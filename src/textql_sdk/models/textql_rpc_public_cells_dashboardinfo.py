...
class TextqlRPCPublicCellsDashboardInfoTypedDict(TypedDict):
    id: NotRequired[str]
...
class TextqlRPCPublicCellsDashboardInfo(BaseModel):
...
try:
    TextqlRPCPublicCellsDashboardInfo.model_rebuild()
except NameError:
    pass
