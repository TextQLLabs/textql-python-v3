...
class PlaybookServiceUpdatePlaybookExtendedQnRequestTypedDict(TypedDict):
    body: TextqlRPCPublicPlaybookUpdatePlaybookExtendedQnRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class PlaybookServiceUpdatePlaybookExtendedQnRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPlaybookUpdatePlaybookExtendedQnRequest,
...
PlaybookServiceUpdatePlaybookExtendedQnResponseTypedDict = TypeAliasType(
...
PlaybookServiceUpdatePlaybookExtendedQnResponse = TypeAliasType(
    "PlaybookServiceUpdatePlaybookExtendedQnResponse",
    Union[TextqlRPCPublicPlaybookUpdatePlaybookExtendedQnResponse, ConnectError],
)


try:
    PlaybookServiceUpdatePlaybookExtendedQnRequest.model_rebuild()
except NameError:
    pass
