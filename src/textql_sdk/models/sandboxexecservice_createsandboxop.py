...
class SandboxExecServiceCreateSandboxRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxExecCreateSandboxRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxExecServiceCreateSandboxRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxExecCreateSandboxRequest,
...
SandboxExecServiceCreateSandboxResponseTypedDict = TypeAliasType(
    "SandboxExecServiceCreateSandboxResponseTypedDict",
    Union[
        TextqlRPCPublicSandboxExecCreateSandboxResponseTypedDict, ConnectErrorTypedDict
    ],
)


SandboxExecServiceCreateSandboxResponse = TypeAliasType(
    "SandboxExecServiceCreateSandboxResponse",
    Union[TextqlRPCPublicSandboxExecCreateSandboxResponse, ConnectError],
)


try:
    SandboxExecServiceCreateSandboxRequest.model_rebuild()
except NameError:
    pass
