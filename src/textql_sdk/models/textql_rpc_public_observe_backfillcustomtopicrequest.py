...
class TextqlRPCPublicObserveBackfillCustomTopicRequestTypedDict(TypedDict):
...
class TextqlRPCPublicObserveBackfillCustomTopicRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["topicId", "startDate", "endDate"])
...
try:
    TextqlRPCPublicObserveBackfillCustomTopicRequest.model_rebuild()
except NameError:
    pass
