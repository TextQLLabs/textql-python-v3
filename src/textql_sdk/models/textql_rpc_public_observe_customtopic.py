...
TagCountTypedDict = TypeAliasType("TagCountTypedDict", Union[int, str])


TagCount = TypeAliasType("TagCount", Union[int, str])
...
class TextqlRPCPublicObserveCustomTopicTypedDict(TypedDict):
    ...
    """
    tag_count: NotRequired[TagCountTypedDict]
...
class TextqlRPCPublicObserveCustomTopic(BaseModel):
    ...
    tag_count: Annotated[Optional[TagCount], pydantic.Field(alias="tagCount")] = None
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["backfillChatId", "backfillStatus", "backfillError"])
...
try:
    TextqlRPCPublicObserveCustomTopic.model_rebuild()
except NameError:
    pass
