...
from .textql_rpc_public_cells_dashboardaction import TextqlRPCPublicCellsDashboardAction
...
class TextqlRPCPublicCellsDashboardCellTypedDict(TypedDict):
    ...
    action: NotRequired[TextqlRPCPublicCellsDashboardAction]
    type: NotRequired[Nullable[str]]
    r"""Dashboard type: \"streamlit\" or \"dash\" """
...
class TextqlRPCPublicCellsDashboardCell(BaseModel):
    ...
    action: Optional[TextqlRPCPublicCellsDashboardAction] = None
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["errorMessage", "screenshotUrl", "lastRunAt", "type"])
...
try:
    TextqlRPCPublicCellsDashboardCell.model_rebuild()
except NameError:
    pass
