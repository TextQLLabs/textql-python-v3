...
class RBACServiceHasObjectAccessRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacHasObjectAccessRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceHasObjectAccessRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacHasObjectAccessRequest,
...
RBACServiceHasObjectAccessResponseTypedDict = TypeAliasType(
    "RBACServiceHasObjectAccessResponseTypedDict",
    Union[TextqlRPCPublicRbacHasObjectAccessResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceHasObjectAccessResponse = TypeAliasType(
    "RBACServiceHasObjectAccessResponse",
    Union[TextqlRPCPublicRbacHasObjectAccessResponse, ConnectError],
)


try:
    RBACServiceHasObjectAccessRequest.model_rebuild()
except NameError:
    pass
