...
class TextqlRPCPublicTableauTableauWorkbookTypedDict(TypedDict):
    id: NotRequired[str]
...
class TextqlRPCPublicTableauTableauWorkbook(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["id", "name", "projectName", "projectId", "createdAt", "updatedAt"]
        )
...
try:
    TextqlRPCPublicTableauTableauWorkbook.model_rebuild()
except NameError:
    pass
