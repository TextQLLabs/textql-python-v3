...
class SandboxQueryServiceExecuteBashRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxQuerySandboxExecuteBashRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxQueryServiceExecuteBashRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxQuerySandboxExecuteBashRequest,
...
SandboxQueryServiceExecuteBashResponseTypedDict = TypeAliasType(
...
SandboxQueryServiceExecuteBashResponse = TypeAliasType(
    "SandboxQueryServiceExecuteBashResponse",
    Union[ConnectError, TextqlRPCPublicSandboxQuerySandboxExecuteBashResponse],
)


try:
    SandboxQueryServiceExecuteBashRequest.model_rebuild()
except NameError:
    pass
