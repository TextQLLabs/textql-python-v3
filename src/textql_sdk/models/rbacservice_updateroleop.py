...
class RBACServiceUpdateRoleRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacUpdateRoleRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceUpdateRoleRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacUpdateRoleRequest,
...
RBACServiceUpdateRoleResponseTypedDict = TypeAliasType(
    "RBACServiceUpdateRoleResponseTypedDict",
    Union[TextqlRPCPublicRbacUpdateRoleResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceUpdateRoleResponse = TypeAliasType(
    "RBACServiceUpdateRoleResponse",
    Union[TextqlRPCPublicRbacUpdateRoleResponse, ConnectError],
)


try:
    RBACServiceUpdateRoleRequest.model_rebuild()
except NameError:
    pass
