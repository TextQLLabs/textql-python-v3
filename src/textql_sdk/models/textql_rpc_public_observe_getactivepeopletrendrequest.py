...
class TextqlRPCPublicObserveGetActivePeopleTrendRequestTypedDict(TypedDict):
...
class TextqlRPCPublicObserveGetActivePeopleTrendRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["days", "startDate", "endDate"])
...
try:
    TextqlRPCPublicObserveGetActivePeopleTrendRequest.model_rebuild()
except NameError:
    pass
