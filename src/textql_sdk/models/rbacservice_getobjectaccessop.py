...
class RBACServiceGetObjectAccessRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacGetObjectAccessRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceGetObjectAccessRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacGetObjectAccessRequest,
...
RBACServiceGetObjectAccessResponseTypedDict = TypeAliasType(
    "RBACServiceGetObjectAccessResponseTypedDict",
    Union[TextqlRPCPublicRbacGetObjectAccessResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceGetObjectAccessResponse = TypeAliasType(
    "RBACServiceGetObjectAccessResponse",
    Union[TextqlRPCPublicRbacGetObjectAccessResponse, ConnectError],
)


try:
    RBACServiceGetObjectAccessRequest.model_rebuild()
except NameError:
    pass
