...
class LibraryServiceListContextPatchAutoApproveRulesRequestTypedDict(TypedDict):
...
class LibraryServiceListContextPatchAutoApproveRulesRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesListContextPatchAutoApproveRulesRequest,
...
LibraryServiceListContextPatchAutoApproveRulesResponseTypedDict = TypeAliasType(
...
LibraryServiceListContextPatchAutoApproveRulesResponse = TypeAliasType(
...
try:
    LibraryServiceListContextPatchAutoApproveRulesRequest.model_rebuild()
except NameError:
    pass
