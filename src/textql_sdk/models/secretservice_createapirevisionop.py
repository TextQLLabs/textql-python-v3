...
class SecretServiceCreateAPIRevisionRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretCreateAPIRevisionRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServiceCreateAPIRevisionRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretCreateAPIRevisionRequest,
...
SecretServiceCreateAPIRevisionResponseTypedDict = TypeAliasType(
    "SecretServiceCreateAPIRevisionResponseTypedDict",
    Union[
        TextqlRPCPublicSecretCreateAPIRevisionResponseTypedDict, ConnectErrorTypedDict
    ],
)


SecretServiceCreateAPIRevisionResponse = TypeAliasType(
    "SecretServiceCreateAPIRevisionResponse",
    Union[TextqlRPCPublicSecretCreateAPIRevisionResponse, ConnectError],
)


try:
    SecretServiceCreateAPIRevisionRequest.model_rebuild()
except NameError:
    pass
