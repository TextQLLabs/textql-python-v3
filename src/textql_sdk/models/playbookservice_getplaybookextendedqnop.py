...
class PlaybookServiceGetPlaybookExtendedQnRequestTypedDict(TypedDict):
    body: TextqlRPCPublicPlaybookGetPlaybookExtendedQnRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class PlaybookServiceGetPlaybookExtendedQnRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPlaybookGetPlaybookExtendedQnRequest,
...
PlaybookServiceGetPlaybookExtendedQnResponseTypedDict = TypeAliasType(
...
PlaybookServiceGetPlaybookExtendedQnResponse = TypeAliasType(
    "PlaybookServiceGetPlaybookExtendedQnResponse",
    Union[TextqlRPCPublicPlaybookGetPlaybookExtendedQnResponse, ConnectError],
)


try:
    PlaybookServiceGetPlaybookExtendedQnRequest.model_rebuild()
except NameError:
    pass
