...
from .textql_rpc_public_patches_usageorderby import TextqlRPCPublicPatchesUsageOrderBy
...
class TextqlRPCPublicPatchesGetFileUsageRequestTypedDict(TypedDict):
    path_prefix: NotRequired[Nullable[str]]
    order: NotRequired[TextqlRPCPublicPatchesUsageOrderBy]
...
class TextqlRPCPublicPatchesGetFileUsageRequest(BaseModel):
    ...
    order: Optional[TextqlRPCPublicPatchesUsageOrderBy] = None
    ...
    page_cursor: Annotated[
        OptionalNullable[str], pydantic.Field(alias="pageCursor")
    ] = UNSET
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["pathPrefix", "order", "observationPeriod", "pageCursor", "pageSize"]
        )
        nullable_fields = set(["pathPrefix", "pageCursor", "pageSize"])
...
try:
    TextqlRPCPublicPatchesGetFileUsageRequest.model_rebuild()
except NameError:
    pass
