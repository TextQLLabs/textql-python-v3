...
class RBACServiceWhoAmIRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacWhoAmIRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceWhoAmIRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacWhoAmIRequest,
...
RBACServiceWhoAmIResponseTypedDict = TypeAliasType(
    "RBACServiceWhoAmIResponseTypedDict",
    Union[ConnectErrorTypedDict, TextqlRPCPublicRbacWhoAmIResponseTypedDict],
)


RBACServiceWhoAmIResponse = TypeAliasType(
    "RBACServiceWhoAmIResponse", Union[ConnectError, TextqlRPCPublicRbacWhoAmIResponse]
)


try:
    RBACServiceWhoAmIRequest.model_rebuild()
except NameError:
    pass
