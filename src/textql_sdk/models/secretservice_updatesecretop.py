...
class SecretServiceUpdateSecretRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretUpdateSecretRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServiceUpdateSecretRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretUpdateSecretRequest,
...
SecretServiceUpdateSecretResponseTypedDict = TypeAliasType(
    "SecretServiceUpdateSecretResponseTypedDict",
    Union[TextqlRPCPublicSecretUpdateSecretResponseTypedDict, ConnectErrorTypedDict],
)


SecretServiceUpdateSecretResponse = TypeAliasType(
    "SecretServiceUpdateSecretResponse",
    Union[TextqlRPCPublicSecretUpdateSecretResponse, ConnectError],
)


try:
    SecretServiceUpdateSecretRequest.model_rebuild()
except NameError:
    pass
