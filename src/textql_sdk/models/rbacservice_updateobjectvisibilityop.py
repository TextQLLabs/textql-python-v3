...
class RBACServiceUpdateObjectVisibilityRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacUpdateObjectVisibilityRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceUpdateObjectVisibilityRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacUpdateObjectVisibilityRequest,
...
RBACServiceUpdateObjectVisibilityResponseTypedDict = TypeAliasType(
...
RBACServiceUpdateObjectVisibilityResponse = TypeAliasType(
    "RBACServiceUpdateObjectVisibilityResponse",
    Union[TextqlRPCPublicRbacUpdateObjectVisibilityResponse, ConnectError],
)


try:
    RBACServiceUpdateObjectVisibilityRequest.model_rebuild()
except NameError:
    pass
