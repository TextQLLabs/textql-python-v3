...
from .textql_rpc_public_app_getappviewstatsrequest import (
...
class AppServiceGetAppViewStatsRequestTypedDict(TypedDict):
    body: TextqlRPCPublicAppGetAppViewStatsRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class AppServiceGetAppViewStatsRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicAppGetAppViewStatsRequest,
...
AppServiceGetAppViewStatsResponseTypedDict = TypeAliasType(
    "AppServiceGetAppViewStatsResponseTypedDict",
    Union[TextqlRPCPublicAppGetAppViewStatsResponseTypedDict, ConnectErrorTypedDict],
)


AppServiceGetAppViewStatsResponse = TypeAliasType(
    "AppServiceGetAppViewStatsResponse",
    Union[TextqlRPCPublicAppGetAppViewStatsResponse, ConnectError],
)


try:
    AppServiceGetAppViewStatsRequest.model_rebuild()
except NameError:
    pass
