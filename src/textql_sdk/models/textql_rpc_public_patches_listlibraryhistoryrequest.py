...
class TextqlRPCPublicPatchesListLibraryHistoryRequestTypedDict(TypedDict):
    page_size: NotRequired[Nullable[int]]
    page_token: NotRequired[Nullable[str]]
    path: NotRequired[Nullable[str]]


class TextqlRPCPublicPatchesListLibraryHistoryRequest(BaseModel):
...
try:
    TextqlRPCPublicPatchesListLibraryHistoryRequest.model_rebuild()
except NameError:
    pass
