...
class RBACServiceShareObjectRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacShareObjectRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceShareObjectRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacShareObjectRequest,
...
RBACServiceShareObjectResponseTypedDict = TypeAliasType(
    "RBACServiceShareObjectResponseTypedDict",
    Union[TextqlRPCPublicRbacShareObjectResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceShareObjectResponse = TypeAliasType(
    "RBACServiceShareObjectResponse",
    Union[TextqlRPCPublicRbacShareObjectResponse, ConnectError],
)


try:
    RBACServiceShareObjectRequest.model_rebuild()
except NameError:
    pass
