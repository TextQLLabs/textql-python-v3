...
class ChatServiceBookmarkChatRequestTypedDict(TypedDict):
    body: TextqlRPCPublicChatBookmarkChatRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class ChatServiceBookmarkChatRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicChatBookmarkChatRequest,
...
ChatServiceBookmarkChatResponseTypedDict = TypeAliasType(
    "ChatServiceBookmarkChatResponseTypedDict",
    Union[GoogleProtobufEmptyTypedDict, ConnectErrorTypedDict],
)


ChatServiceBookmarkChatResponse = TypeAliasType(
    "ChatServiceBookmarkChatResponse", Union[GoogleProtobufEmpty, ConnectError]
)


try:
    ChatServiceBookmarkChatRequest.model_rebuild()
except NameError:
    pass
