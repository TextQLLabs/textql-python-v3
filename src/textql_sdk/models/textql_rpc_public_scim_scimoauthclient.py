...
class TextqlRPCPublicScimScimOAuthClientTypedDict(TypedDict):
    id: NotRequired[str]
...
class TextqlRPCPublicScimScimOAuthClient(BaseModel):
...
try:
    TextqlRPCPublicScimScimOAuthClient.model_rebuild()
except NameError:
    pass
