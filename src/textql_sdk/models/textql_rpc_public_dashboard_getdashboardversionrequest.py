...
class TextqlRPCPublicDashboardGetDashboardVersionRequestTypedDict(TypedDict):
    dashboard_id: NotRequired[str]
    version_number: NotRequired[int]


class TextqlRPCPublicDashboardGetDashboardVersionRequest(BaseModel):
...
try:
    TextqlRPCPublicDashboardGetDashboardVersionRequest.model_rebuild()
except NameError:
    pass
