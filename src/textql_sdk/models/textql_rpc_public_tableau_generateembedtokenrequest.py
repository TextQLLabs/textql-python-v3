...
class TextqlRPCPublicTableauGenerateEmbedTokenRequestTypedDict(TypedDict):
    connector_id: NotRequired[int]
    view_id: NotRequired[str]


class TextqlRPCPublicTableauGenerateEmbedTokenRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["connectorId", "viewId"])
...
try:
    TextqlRPCPublicTableauGenerateEmbedTokenRequest.model_rebuild()
except NameError:
    pass
