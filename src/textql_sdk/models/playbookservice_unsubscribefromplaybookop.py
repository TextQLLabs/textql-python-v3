...
from .textql_rpc_public_playbook_unsubscribefromplaybookrequest import (
...
class PlaybookServiceUnsubscribeFromPlaybookRequestTypedDict(TypedDict):
    body: TextqlRPCPublicPlaybookUnsubscribeFromPlaybookRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class PlaybookServiceUnsubscribeFromPlaybookRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPlaybookUnsubscribeFromPlaybookRequest,
...
PlaybookServiceUnsubscribeFromPlaybookResponseTypedDict = TypeAliasType(
...
PlaybookServiceUnsubscribeFromPlaybookResponse = TypeAliasType(
    "PlaybookServiceUnsubscribeFromPlaybookResponse",
    Union[TextqlRPCPublicPlaybookUnsubscribeFromPlaybookResponse, ConnectError],
)


try:
    PlaybookServiceUnsubscribeFromPlaybookRequest.model_rebuild()
except NameError:
    pass
