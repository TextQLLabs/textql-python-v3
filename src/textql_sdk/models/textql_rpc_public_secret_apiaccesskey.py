...
class TextqlRPCPublicSecretAPIAccessKeyTypedDict(TypedDict):
    id: NotRequired[str]
    ...
    r"""\"token\", \"oauth_u2m\", \"oauth_per_member\" """
    member_oauth_authenticated: NotRequired[bool]
    member_oauth_display_name: NotRequired[str]
    ...
    access_type: NotRequired[Nullable[str]]
...
class TextqlRPCPublicSecretAPIAccessKey(BaseModel):
    ...
    query_params: Annotated[
        Optional[Dict[str, str]], pydantic.Field(alias="queryParams")
    ] = None
    ...
    member_oauth_authenticated: Annotated[
        Optional[bool], pydantic.Field(alias="memberOauthAuthenticated")
    ] = None

    member_oauth_display_name: Annotated[
        Optional[str], pydantic.Field(alias="memberOauthDisplayName")
    ] = None

    http_basic_auth: Annotated[
        Optional[TextqlRPCPublicSecretHTTPBasicAuth],
        pydantic.Field(alias="httpBasicAuth"),
    ] = None

    body: Optional[Dict[str, str]] = None

    content_type: Annotated[
        Optional[TextqlRPCPublicSecretBodyContentType],
    ...
    access_type: Annotated[
        OptionalNullable[str], pydantic.Field(alias="accessType")
    ] = UNSET
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            [
                ...
                "provider",
                "authType",
                "memberOauthAuthenticated",
                "memberOauthDisplayName",
                "httpBasicAuth",
                "body",
                "contentType",
                "canWrite",
        ...
        nullable_fields = set(["accessType"])
...
try:
    TextqlRPCPublicSecretAPIAccessKey.model_rebuild()
except NameError:
    pass
