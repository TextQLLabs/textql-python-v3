...
class RBACServiceUpdateObjectAccessRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacUpdateObjectAccessRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceUpdateObjectAccessRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacUpdateObjectAccessRequest,
...
RBACServiceUpdateObjectAccessResponseTypedDict = TypeAliasType(
    "RBACServiceUpdateObjectAccessResponseTypedDict",
    Union[
        TextqlRPCPublicRbacUpdateObjectAccessResponseTypedDict, ConnectErrorTypedDict
    ],
)


RBACServiceUpdateObjectAccessResponse = TypeAliasType(
    "RBACServiceUpdateObjectAccessResponse",
    Union[TextqlRPCPublicRbacUpdateObjectAccessResponse, ConnectError],
)


try:
    RBACServiceUpdateObjectAccessRequest.model_rebuild()
except NameError:
    pass
