...
class TextqlRPCPublicTableauListTableauWorkbooksRequestTypedDict(TypedDict):
    connector_id: NotRequired[int]
    project_id: NotRequired[str]
    project_name: NotRequired[str]


class TextqlRPCPublicTableauListTableauWorkbooksRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["connectorId", "projectId", "projectName"])
...
try:
    TextqlRPCPublicTableauListTableauWorkbooksRequest.model_rebuild()
except NameError:
    pass
