...
class TextqlRPCPublicScimScimTokenTypedDict(TypedDict):
    id: NotRequired[str]
...
class TextqlRPCPublicScimScimToken(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["id", "description", "createdBy", "expiresAt", "revokedAt", "createdAt"]
        )
...
try:
    TextqlRPCPublicScimScimToken.model_rebuild()
except NameError:
    pass
