...
from .textql_rpc_public_chat_getllmusagerequest import (
    TextqlRPCPublicChatGetLlmUsageRequest,
    TextqlRPCPublicChatGetLlmUsageRequestTypedDict,
)
from .textql_rpc_public_chat_getllmusageresponse import (
    TextqlRPCPublicChatGetLlmUsageResponse,
    TextqlRPCPublicChatGetLlmUsageResponseTypedDict,
)
import pydantic
...
class ChatServiceGetLlmUsageRequestTypedDict(TypedDict):
    body: TextqlRPCPublicChatGetLlmUsageRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class ChatServiceGetLlmUsageRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicChatGetLlmUsageRequest,
...
try:
    ChatServiceGetLlmUsageRequest.model_rebuild()
except NameError:
    pass
