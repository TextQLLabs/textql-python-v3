...
class AppServiceVerifyAppRenderRequestTypedDict(TypedDict):
    body: TextqlRPCPublicAppVerifyAppRenderRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class AppServiceVerifyAppRenderRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicAppVerifyAppRenderRequest,
...
AppServiceVerifyAppRenderResponseTypedDict = TypeAliasType(
    "AppServiceVerifyAppRenderResponseTypedDict",
    Union[TextqlRPCPublicAppVerifyAppRenderResponseTypedDict, ConnectErrorTypedDict],
)


AppServiceVerifyAppRenderResponse = TypeAliasType(
    "AppServiceVerifyAppRenderResponse",
    Union[TextqlRPCPublicAppVerifyAppRenderResponse, ConnectError],
)


try:
    AppServiceVerifyAppRenderRequest.model_rebuild()
except NameError:
    pass
