...
from .textql_rpc_public_rbac_listapikeysresponse import (
...
class RBACServiceListAPIKeysRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacListAPIKeysRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceListAPIKeysRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacListAPIKeysRequest,
...
RBACServiceListAPIKeysResponseTypedDict = TypeAliasType(
    "RBACServiceListAPIKeysResponseTypedDict",
    Union[TextqlRPCPublicRbacListAPIKeysResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceListAPIKeysResponse = TypeAliasType(
    "RBACServiceListAPIKeysResponse",
    Union[TextqlRPCPublicRbacListAPIKeysResponse, ConnectError],
)


try:
    RBACServiceListAPIKeysRequest.model_rebuild()
except NameError:
    pass
