...
class TextqlRPCPublicRbacGetRolePermissionsResponseTypedDict(TypedDict):
    permissions: NotRequired[List[TextqlRPCPublicRbacPermissionTypedDict]]


class TextqlRPCPublicRbacGetRolePermissionsResponse(BaseModel):
    permissions: Optional[List[TextqlRPCPublicRbacPermission]] = None

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["permissions"])
