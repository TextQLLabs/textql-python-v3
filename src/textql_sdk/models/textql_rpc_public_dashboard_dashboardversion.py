...
class TextqlRPCPublicDashboardDashboardVersionTypedDict(TypedDict):
    r"""Version history"""
    ...
    """
    publisher: NotRequired[TextqlRPCPublicDashboardDashboardCreatorTypedDict]


class TextqlRPCPublicDashboardDashboardVersion(BaseModel):
    r"""Version history"""
    ...
    publisher: Optional[TextqlRPCPublicDashboardDashboardCreator] = None
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["description", "label"])
...
try:
    TextqlRPCPublicDashboardDashboardVersion.model_rebuild()
except NameError:
    pass
