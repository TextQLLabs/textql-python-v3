...
class SandboxExecServiceLoadConnectorDataRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxExecSandboxLoadConnectorDataRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxExecServiceLoadConnectorDataRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxExecSandboxLoadConnectorDataRequest,
...
SandboxExecServiceLoadConnectorDataResponseTypedDict = TypeAliasType(
...
SandboxExecServiceLoadConnectorDataResponse = TypeAliasType(
    "SandboxExecServiceLoadConnectorDataResponse",
    Union[TextqlRPCPublicSandboxExecSandboxLoadConnectorDataResponse, ConnectError],
)


try:
    SandboxExecServiceLoadConnectorDataRequest.model_rebuild()
except NameError:
    pass
