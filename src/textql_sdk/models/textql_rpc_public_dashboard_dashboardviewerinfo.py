...
class TextqlRPCPublicDashboardDashboardViewerInfoTypedDict(TypedDict):
...
class TextqlRPCPublicDashboardDashboardViewerInfo(BaseModel):
    ...
    recent_view_times: Annotated[
        Optional[List[datetime]], pydantic.Field(alias="recentViewTimes")
    ] = None

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(
            ["memberId", "lastViewed", "viewCount", "displayName", "recentViewTimes"]
        )
        nullable_fields = set(["displayName"])
...
try:
    TextqlRPCPublicDashboardDashboardViewerInfo.model_rebuild()
except NameError:
    pass
