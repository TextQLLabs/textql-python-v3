...
class TextqlRPCPublicRbacGroupTypedDict(TypedDict):
    id: NotRequired[str]
    ...
    connector_count: NotRequired[int]


class TextqlRPCPublicRbacGroup(BaseModel):
    ...
    connector_count: Annotated[
        Optional[int], pydantic.Field(alias="connectorCount")
    ] = None
...
try:
    TextqlRPCPublicRbacGroup.model_rebuild()
except NameError:
    pass
