...
class TextqlRPCPublicDashboardGetMembersWithDashboardsResponseTypedDict(TypedDict):
    members: NotRequired[List[TextqlRPCIdentityMemberPreviewTypedDict]]


class TextqlRPCPublicDashboardGetMembersWithDashboardsResponse(BaseModel):
