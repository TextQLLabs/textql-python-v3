...
class SandboxCapabilityServicePollAskRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxCapabilitySandboxPollAskRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxCapabilityServicePollAskRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxCapabilitySandboxPollAskRequest,
...
SandboxCapabilityServicePollAskResponseTypedDict = TypeAliasType(
...
SandboxCapabilityServicePollAskResponse = TypeAliasType(
    "SandboxCapabilityServicePollAskResponse",
    Union[ConnectError, TextqlRPCPublicSandboxCapabilitySandboxPollAskResponse],
)


try:
    SandboxCapabilityServicePollAskRequest.model_rebuild()
except NameError:
    pass
