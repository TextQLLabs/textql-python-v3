...
class RBACServiceCreatePersonalAPIKeyRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacCreatePersonalAPIKeyRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceCreatePersonalAPIKeyRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacCreatePersonalAPIKeyRequest,
...
RBACServiceCreatePersonalAPIKeyResponseTypedDict = TypeAliasType(
...
RBACServiceCreatePersonalAPIKeyResponse = TypeAliasType(
...
try:
    RBACServiceCreatePersonalAPIKeyRequest.model_rebuild()
except NameError:
    pass
