...
class TextqlRPCPublicRbacObjectAccessTypedDict(TypedDict):
    id: NotRequired[str]
...
class TextqlRPCPublicRbacObjectAccess(BaseModel):
    ...
    granted_by: Annotated[OptionalNullable[str], pydantic.Field(alias="grantedBy")] = (
        UNSET
    )
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(
            ["createdBy", "memberId", "roleId", "grantedBy", "groupId"]
        )
...
try:
    TextqlRPCPublicRbacObjectAccess.model_rebuild()
except NameError:
    pass
