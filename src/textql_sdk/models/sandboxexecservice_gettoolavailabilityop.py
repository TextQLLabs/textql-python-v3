...
class SandboxExecServiceGetToolAvailabilityRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxExecGetToolAvailabilityRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxExecServiceGetToolAvailabilityRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxExecGetToolAvailabilityRequest,
...
SandboxExecServiceGetToolAvailabilityResponseTypedDict = TypeAliasType(
...
SandboxExecServiceGetToolAvailabilityResponse = TypeAliasType(
    "SandboxExecServiceGetToolAvailabilityResponse",
    Union[TextqlRPCPublicSandboxExecGetToolAvailabilityResponse, ConnectError],
)


try:
    SandboxExecServiceGetToolAvailabilityRequest.model_rebuild()
except NameError:
    pass
