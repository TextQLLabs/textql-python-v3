...
class SecretServiceDeleteSecretRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretDeleteSecretRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServiceDeleteSecretRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretDeleteSecretRequest,
...
SecretServiceDeleteSecretResponseTypedDict = TypeAliasType(
    "SecretServiceDeleteSecretResponseTypedDict",
    Union[TextqlRPCPublicSecretDeleteSecretResponseTypedDict, ConnectErrorTypedDict],
)


SecretServiceDeleteSecretResponse = TypeAliasType(
    "SecretServiceDeleteSecretResponse",
    Union[TextqlRPCPublicSecretDeleteSecretResponse, ConnectError],
)


try:
    SecretServiceDeleteSecretRequest.model_rebuild()
except NameError:
    pass
