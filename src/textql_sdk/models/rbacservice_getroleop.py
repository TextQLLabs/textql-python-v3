...
from .textql_rpc_public_rbac_getrolerequest import (
...
class RBACServiceGetRoleRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacGetRoleRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceGetRoleRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacGetRoleRequest,
...
RBACServiceGetRoleResponseTypedDict = TypeAliasType(
    "RBACServiceGetRoleResponseTypedDict",
    Union[TextqlRPCPublicRbacGetRoleResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceGetRoleResponse = TypeAliasType(
    "RBACServiceGetRoleResponse",
    Union[TextqlRPCPublicRbacGetRoleResponse, ConnectError],
)


try:
    RBACServiceGetRoleRequest.model_rebuild()
except NameError:
    pass
