...
class RBACServiceListAccessRequestsRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacListAccessRequestsRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceListAccessRequestsRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacListAccessRequestsRequest,
...
RBACServiceListAccessRequestsResponseTypedDict = TypeAliasType(
    "RBACServiceListAccessRequestsResponseTypedDict",
    Union[
        TextqlRPCPublicRbacListAccessRequestsResponseTypedDict, ConnectErrorTypedDict
    ],
)


RBACServiceListAccessRequestsResponse = TypeAliasType(
    "RBACServiceListAccessRequestsResponse",
    Union[TextqlRPCPublicRbacListAccessRequestsResponse, ConnectError],
)


try:
    RBACServiceListAccessRequestsRequest.model_rebuild()
except NameError:
    pass
