...
class TextqlRPCPublicRbacAccessRequestTypedDict(TypedDict):
    id: NotRequired[str]
...
class TextqlRPCPublicRbacAccessRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["requestMessage", "reviewedBy", "rejectionReason"])
...
try:
    TextqlRPCPublicRbacAccessRequest.model_rebuild()
except NameError:
    pass
