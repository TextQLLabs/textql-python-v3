...
class TextqlRPCPublicObserveDashboardBillingStat(BaseModel):
    ...
    last_viewed_at: Annotated[
        Optional[datetime], pydantic.Field(alias="lastViewedAt")
    ] = None
    r"""A Timestamp represents a point in time independent of any time zone or local
    calendar, encoded as a count of seconds and fractions of seconds at
    nanosecond resolution. The count is relative to an epoch at UTC midnight on
    ...
    daily_view_counts: Annotated[
        Optional[List[int]], pydantic.Field(alias="dailyViewCounts")
    ] = None
...
try:
    TextqlRPCPublicObserveDashboardBillingStat.model_rebuild()
except NameError:
    pass
