...
from .textql_rpc_public_rbac_createapikeyresponse import (
...
class RBACServiceCreateAPIKeyRequestTypedDict(TypedDict):
    body: TextqlRPCPublicRbacCreateAPIKeyRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class RBACServiceCreateAPIKeyRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicRbacCreateAPIKeyRequest,
...
RBACServiceCreateAPIKeyResponseTypedDict = TypeAliasType(
    "RBACServiceCreateAPIKeyResponseTypedDict",
    Union[TextqlRPCPublicRbacCreateAPIKeyResponseTypedDict, ConnectErrorTypedDict],
)


RBACServiceCreateAPIKeyResponse = TypeAliasType(
    "RBACServiceCreateAPIKeyResponse",
    Union[TextqlRPCPublicRbacCreateAPIKeyResponse, ConnectError],
)


try:
    RBACServiceCreateAPIKeyRequest.model_rebuild()
except NameError:
    pass
