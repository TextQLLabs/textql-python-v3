...
from .textql_rpc_public_chat_chatsortfield import TextqlRPCPublicChatChatSortField
...
class TextqlRPCPublicChatGetChatsRequest(BaseModel):
    ...
    sort_by: Annotated[
        Optional[TextqlRPCPublicChatChatSortField], pydantic.Field(alias="sortBy")
    ] = None

    sort_direction: Annotated[
        Optional[TextqlRPCPublicChatChatSortDirection],
    ...
    exclude_feed: Annotated[
        OptionalNullable[bool], pydantic.Field(alias="excludeFeed")
    ] = UNSET
...
try:
    TextqlRPCPublicChatGetChatsRequest.model_rebuild()
except NameError:
    pass
