...
class TextqlRPCPublicRbacGetMemberGroupsRequestTypedDict(TypedDict):
    member_ids: NotRequired[List[str]]


class TextqlRPCPublicRbacGetMemberGroupsRequest(BaseModel):
...
try:
    TextqlRPCPublicRbacGetMemberGroupsRequest.model_rebuild()
except NameError:
    pass
