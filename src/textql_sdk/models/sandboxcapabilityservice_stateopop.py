...
from .textql_rpc_public_sandbox_capability_sandboxstateopresponse import (
...
class SandboxCapabilityServiceStateOpRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxCapabilitySandboxStateOpRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxCapabilityServiceStateOpRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxCapabilitySandboxStateOpRequest,
...
SandboxCapabilityServiceStateOpResponseTypedDict = TypeAliasType(
...
SandboxCapabilityServiceStateOpResponse = TypeAliasType(
    "SandboxCapabilityServiceStateOpResponse",
    Union[ConnectError, TextqlRPCPublicSandboxCapabilitySandboxStateOpResponse],
)


try:
    SandboxCapabilityServiceStateOpRequest.model_rebuild()
except NameError:
    pass
