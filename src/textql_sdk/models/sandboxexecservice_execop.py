...
class SandboxExecServiceExecRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxExecSandboxExecRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxExecServiceExecRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxExecSandboxExecRequest,
...
SandboxExecServiceExecResponseTypedDict = TypeAliasType(
    "SandboxExecServiceExecResponseTypedDict",
    Union[
        TextqlRPCPublicSandboxExecSandboxExecResponseTypedDict, ConnectErrorTypedDict
    ],
)


SandboxExecServiceExecResponse = TypeAliasType(
    "SandboxExecServiceExecResponse",
    Union[TextqlRPCPublicSandboxExecSandboxExecResponse, ConnectError],
)


try:
    SandboxExecServiceExecRequest.model_rebuild()
except NameError:
    pass
