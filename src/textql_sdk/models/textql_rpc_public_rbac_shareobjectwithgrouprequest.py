...
class TextqlRPCPublicRbacShareObjectWithGroupRequestTypedDict(TypedDict):
...
class TextqlRPCPublicRbacShareObjectWithGroupRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["objectType", "objectId", "groupId", "accessType", "expiresAt", "isPublic"]
        )
...
try:
    TextqlRPCPublicRbacShareObjectWithGroupRequest.model_rebuild()
except NameError:
    pass
