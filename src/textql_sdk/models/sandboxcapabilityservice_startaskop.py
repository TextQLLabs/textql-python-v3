...
class SandboxCapabilityServiceStartAskRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSandboxCapabilitySandboxStartAskRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SandboxCapabilityServiceStartAskRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSandboxCapabilitySandboxStartAskRequest,
...
SandboxCapabilityServiceStartAskResponseTypedDict = TypeAliasType(
...
SandboxCapabilityServiceStartAskResponse = TypeAliasType(
    "SandboxCapabilityServiceStartAskResponse",
    Union[ConnectError, TextqlRPCPublicSandboxCapabilitySandboxStartAskResponse],
)


try:
    SandboxCapabilityServiceStartAskRequest.model_rebuild()
except NameError:
    pass
