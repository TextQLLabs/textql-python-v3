...
from .textql_rpc_public_secret_apiaccessref import (
...
class TextqlRPCPublicSecretUpsertAPIAccessKeyRequestTypedDict(TypedDict):
    ref: NotRequired[TextqlRPCPublicSecretAPIAccessRefTypedDict]
    persist_to_db: NotRequired[bool]
...
class TextqlRPCPublicSecretUpsertAPIAccessKeyRequest(BaseModel):
    ref: Optional[TextqlRPCPublicSecretAPIAccessRef] = None

    persist_to_db: Annotated[Optional[bool], pydantic.Field(alias="persistToDb")] = None
    ...
    auth_value: Annotated[Optional[str], pydantic.Field(alias="authValue")] = None

    auth_value_extra: Annotated[
...
try:
    TextqlRPCPublicSecretUpsertAPIAccessKeyRequest.model_rebuild()
except NameError:
    pass
