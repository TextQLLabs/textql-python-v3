...
from .textql_rpc_public_patches_deletecontextpatchautoapproverulerequest import (
    ...
    TextqlRPCPublicPatchesDeleteContextPatchAutoApproveRuleRequestTypedDict,
)
import pydantic
...
class LibraryServiceDeleteContextPatchAutoApproveRuleRequestTypedDict(TypedDict):
...
class LibraryServiceDeleteContextPatchAutoApproveRuleRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesDeleteContextPatchAutoApproveRuleRequest,
...
LibraryServiceDeleteContextPatchAutoApproveRuleResponseTypedDict = TypeAliasType(
    "LibraryServiceDeleteContextPatchAutoApproveRuleResponseTypedDict",
    Union[GoogleProtobufEmptyTypedDict, ConnectErrorTypedDict],
)


LibraryServiceDeleteContextPatchAutoApproveRuleResponse = TypeAliasType(
...
try:
    LibraryServiceDeleteContextPatchAutoApproveRuleRequest.model_rebuild()
except NameError:
    pass
