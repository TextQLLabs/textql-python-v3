...
class SecretServiceDeleteAPIAccessKeyRequestTypedDict(TypedDict):
    body: TextqlRPCPublicSecretDeleteAPIAccessKeyRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class SecretServiceDeleteAPIAccessKeyRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicSecretDeleteAPIAccessKeyRequest,
...
SecretServiceDeleteAPIAccessKeyResponseTypedDict = TypeAliasType(
    "SecretServiceDeleteAPIAccessKeyResponseTypedDict",
    Union[
        TextqlRPCPublicSecretDeleteAPIAccessKeyResponseTypedDict, ConnectErrorTypedDict
    ],
)


SecretServiceDeleteAPIAccessKeyResponse = TypeAliasType(
    "SecretServiceDeleteAPIAccessKeyResponse",
    Union[TextqlRPCPublicSecretDeleteAPIAccessKeyResponse, ConnectError],
)


try:
    SecretServiceDeleteAPIAccessKeyRequest.model_rebuild()
except NameError:
    pass
