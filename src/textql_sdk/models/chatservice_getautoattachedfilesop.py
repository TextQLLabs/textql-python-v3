...
class ChatServiceGetAutoAttachedFilesRequestTypedDict(TypedDict):
    body: TextqlRPCPublicChatGetAutoAttachedFilesRequestTypedDict
    connect_protocol_version: float
    connect_timeout_ms: NotRequired[float]


class ChatServiceGetAutoAttachedFilesRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicChatGetAutoAttachedFilesRequest,
...
ChatServiceGetAutoAttachedFilesResponseTypedDict = TypeAliasType(
    "ChatServiceGetAutoAttachedFilesResponseTypedDict",
    Union[
        TextqlRPCPublicChatGetAutoAttachedFilesResponseTypedDict, ConnectErrorTypedDict
    ],
)


ChatServiceGetAutoAttachedFilesResponse = TypeAliasType(
    "ChatServiceGetAutoAttachedFilesResponse",
    Union[TextqlRPCPublicChatGetAutoAttachedFilesResponse, ConnectError],
)


try:
    ChatServiceGetAutoAttachedFilesRequest.model_rebuild()
except NameError:
    pass
