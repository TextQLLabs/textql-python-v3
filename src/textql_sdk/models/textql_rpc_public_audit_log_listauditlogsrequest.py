...
class TextqlRPCPublicAuditLogListAuditLogsRequestTypedDict(TypedDict):
    category: NotRequired[Nullable[str]]
    actor_id: NotRequired[Nullable[str]]
...
class TextqlRPCPublicAuditLogListAuditLogsRequest(BaseModel):
    ...
    actor_id: Annotated[OptionalNullable[str], pydantic.Field(alias="actorId")] = UNSET

    action: OptionalNullable[str] = UNSET

    resource_type: Annotated[
        OptionalNullable[str], pydantic.Field(alias="resourceType")
    ] = UNSET
...
try:
    TextqlRPCPublicAuditLogListAuditLogsRequest.model_rebuild()
except NameError:
    pass
