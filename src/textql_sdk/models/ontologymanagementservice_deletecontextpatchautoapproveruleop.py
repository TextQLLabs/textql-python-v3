...
class OntologyManagementServiceDeleteContextPatchAutoApproveRuleRequestTypedDict(
    TypedDict
):
...
class OntologyManagementServiceDeleteContextPatchAutoApproveRuleRequest(BaseModel):
    body: Annotated[
        TextqlRPCPublicPatchesDeleteContextPatchAutoApproveRuleRequest,
...
OntologyManagementServiceDeleteContextPatchAutoApproveRuleResponseTypedDict = (
    TypeAliasType(
        "OntologyManagementServiceDeleteContextPatchAutoApproveRuleResponseTypedDict",
...
OntologyManagementServiceDeleteContextPatchAutoApproveRuleResponse = TypeAliasType(
...
try:
    OntologyManagementServiceDeleteContextPatchAutoApproveRuleRequest.model_rebuild()
except NameError:
    pass
