...
with TextQL() as text_ql:
    ...
    res = text_ql.scim_service.create_scim_token()
...
with TextQL() as text_ql:
    ...
    res = text_ql.scim_service.list_scim_o_auth_clients(body={})
...
with TextQL() as text_ql:
    ...
    res = text_ql.scim_service.revoke_o_auth_client()
...
with TextQL() as text_ql:
    ...
    res = text_ql.scim_service.revoke_scim_token()
