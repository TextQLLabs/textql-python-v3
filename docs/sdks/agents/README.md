...
| `callable_as_subagent`                                                                                                                                                                                      | *OptionalNullable[bool]*                                                                                                                                                                                    | :heavy_minus_sign:                                                                                                                                                                                          | Unset defaults to true: new agents are delegatable unless the caller opts<br/> out. Mirrors allow_ad_hoc_subagents below.                                                                                   |
