...
* [heartbeat](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/apps/README.md#heartbeat) - Viewer heartbeat: keeps a warm compute worker alive while the app is open so its  billed lifetime tracks the view session (mirrors a dashboard's viewer TTL). No-op  when the app has no warm worker; never spawns one.
...
### [Libraries](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md)

* [add_submodule](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#add_submodule) - AddLibrarySubmodule
* [approve_patch](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#approve_patch) - ApprovePatch
* [configure_library_remote](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#configure_library_remote) - ConfigureLibraryRemote
* [create_approval_rule](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#create_approval_rule) - CreateApprovalRule
* [create_context_patch_auto_approve_rule](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#create_context_patch_auto_approve_rule) - CreateContextPatchAutoApproveRule
* [create_library_directory](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#create_library_directory) - CreateLibraryDirectory
* [create_file_upload_url](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#create_file_upload_url) - CreateLibraryFileUploadUrl
* [delete_approval_rule](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#delete_approval_rule) - DeleteApprovalRule
* [delete_context_patch_auto_approve_rule](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#delete_context_patch_auto_approve_rule) - DeleteContextPatchAutoApproveRule
* [delete_library_directory](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#delete_library_directory) - DeleteLibraryDirectory
* [delete_library_file](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#delete_library_file) - DeleteLibraryFile
* [delete_owners](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#delete_owners) - DeleteLibraryOwners
* [deny_patch](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#deny_patch) - DenyPatch
* [exchange_github_code](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#exchange_github_code) - ExchangeLibraryGithubCode
* [finalize_file_upload](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#finalize_file_upload) - FinalizeLibraryFileUpload
* [get_codeowner_coverage](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_codeowner_coverage) - GetCodeownerCoverage
* [get_config_export_capabilities](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_config_export_capabilities) - GetConfigExportCapabilities
* [get_effective_owners](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_effective_owners) - GetEffectiveLibraryOwners
* [get_file_usage](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_file_usage) - GetFileUsage
* [get_file_usage_timeline](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_file_usage_timeline) - GetFileUsageTimeline
* [get_ana_config](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_ana_config) - GetLibraryAnaConfig
* [get_file](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_file) - GetLibraryFile
* [get_library_github_o_auth_url](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_library_github_o_auth_url) - GetLibraryGithubOAuthURL
* [get_history_file_diff](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_history_file_diff) - GetLibraryHistoryFileDiff
* [get_migration_status](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_migration_status) - GetLibraryMigrationStatus
* [get_library_owners](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_library_owners) - GetLibraryOwners
* [get_remote](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_remote) - GetLibraryRemote
* [get_size_timeline](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_size_timeline) - GetLibrarySizeTimeline
* [get_library_sync_conflicts](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_library_sync_conflicts) - GetLibrarySyncConflicts
* [get_ontology_usage_summary](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_ontology_usage_summary) - GetOntologyUsageSummary
* [get_patch](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_patch) - GetPatch
* [get_patch_by_number](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_patch_by_number) - GetPatchByNumber
* [get_patch_capabilities](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_patch_capabilities) - GetPatchCapabilities
* [get_raw_patch](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_raw_patch) - GetRawPatch
* [get_usage_details_for_file](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#get_usage_details_for_file) - GetUsageDetailsForFile
* [list_approval_rules](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_approval_rules) - ListApprovalRules
* [list_chats_for_file](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_chats_for_file) - ListChatsForFile
* [list_context_patch_auto_approve_rules](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_context_patch_auto_approve_rules) - ListContextPatchAutoApproveRules
* [list_library_entries](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_library_entries) - ListLibraryEntries
* [list_library_history](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_library_history) - ListLibraryHistory
* [list_imports](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_imports) - ListLibraryImports
* [list_library_submodules](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_library_submodules) - ListLibrarySubmodules
* [list_library_sync_runs](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_library_sync_runs) - ListLibrarySyncRuns
* [list_patch_reviewers](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_patch_reviewers) - ListPatchReviewers
* [list_patches](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_patches) - ListPatches
* [list_skills](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#list_skills) - Lists the skills under the library's flat skills/ root that the caller can  read (OWNERS-filtered). Returns display metadata only — never instruction  bodies — feeding the chat composer's `/` autocomplete.
* [migrate_legacy_context](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#migrate_legacy_context) - MigrateLegacyContextToLibrary
* [migrate_ontology](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#migrate_ontology) - MigrateOntologyToLibrary
* [plan_merge](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#plan_merge) - PlanLibraryMerge
* [preview_library_pull_from_remote](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#preview_library_pull_from_remote) - PreviewLibraryPullFromRemote
* [pull_from_remote](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#pull_from_remote) - PullLibraryFromRemote
* [push_library_to_remote](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#push_library_to_remote) - PushLibraryToRemote
* [recover](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#recover) - RecoverLibrary
* [remove_remote](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#remove_remote) - RemoveLibraryRemote
* [remove_library_submodule](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#remove_library_submodule) - RemoveLibrarySubmodule
* [rename_file](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#rename_file) - RenameLibraryFile
* [request_patch_review](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#request_patch_review) - RequestPatchReview
* [resolve_sync_conflict](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#resolve_sync_conflict) - ResolveLibrarySyncConflict
* [restore_patch](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#restore_patch) - RestorePatch
* [revert_patch](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#revert_patch) - RevertPatch
* [save_all_objects_as_config](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#save_all_objects_as_config) - SaveAllObjectsAsConfig
* [save_as_config](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#save_as_config) - SaveObjectAsConfig
* [trigger_config_drift_reconcile](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#trigger_config_drift_reconcile) - TriggerConfigDriftReconcile forces an immediate config-sync catch-up for the  caller's org: if the Library repo's live HEAD differs from the last  reconciled commit, it enqueues a reconcile (otherwise no-op). The on-demand  equivalent of waiting for the periodic drift scan.
* [update_approval_rule](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#update_approval_rule) - UpdateApprovalRule
* [update_context_patch_auto_approve_rule](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#update_context_patch_auto_approve_rule) - UpdateContextPatchAutoApproveRule
* [update_library_sync_config](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#update_library_sync_config) - UpdateLibrarySyncConfig
* [upsert_ana_config](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#upsert_ana_config) - UpsertLibraryAnaConfig
* [upsert_library_file](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#upsert_library_file) - UpsertLibraryFile
* [upsert_owners](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#upsert_owners) - UpsertLibraryOwners
* [validate_config](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraries/README.md#validate_config) - Read-only functional validation of a proposed config: parse + dependency  resolution/reachability, no authorization and no persistence. "ok" means  functionally valid, not "guaranteed to merge" — the merge gate re-checks  authorization at approve time.

### [LibraryService](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraryservice/README.md)

* [library_service_list_golden_files](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraryservice/README.md#library_service_list_golden_files) - ListGoldenFiles
* [library_service_set_library_file_golden](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/libraryservice/README.md#library_service_set_library_file_golden) - SetLibraryFileGolden
...
* [create_api_revision](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/secrets/README.md#create_api_revision) - CreateApiRevision
...
* [migrate_secret_to_api_connector](https://github.com/TextQLLabs/textql-python-v3/blob/master/docs/sdks/secrets/README.md#migrate_secret_to_api_connector) - MigrateSecretToApiConnector
